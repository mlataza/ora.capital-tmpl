...
<body data-new-gr-c-s-check-loaded="14.1052.0" data-gr-ext-installed="">
        ...
        <div class="container">
            <div class="header__box d-flex ng-scope" ng-controller="FacadeHeaderCtrl as vm">
                <a href="/" class="header__logo d-flex align-items-center justify-content-lg-start">
                    <img class="header__logo-svg" src="styles/assets/app/img/logo.svg" alt="">
                </a>
                {literal}
    ...
    <main class="d-flex flex-column">
                ...
                <div class="container__app container__app_px-15">
                    <div class="header__page d-flex justify-content-between align-items-center">
                        <div class="header__page-info d-flex flex-column">
                            <h1 class="header__home-slider1-item-title vis">Confidentiality policy</h1>
                            <p class="header__home-slider1-item-text vis mb-4 mt-1">Investing in {$settings.site_name} you earn from 2.22% to 4.44% from your deposit daily, to 23.5% from referral program, from growing up {include file="token.tpl"} token as well!</p>
                            {include file="home_join.tpl"}
                        </div>
                        <div class="header__page-pic d-none d-lg-flex align-items-center">
                            <img src="styles/assets/app/img/page-rules.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="rules">
            <div class="container__app container__app_px-15 page_wysiwyg">
                <h2>
                    <p>
                        1. Принятие Условий</p>
                    <p>By accessing the website, you agree to be bound by our Terms and all applicable laws, rules and regulations, and you agree that you are responsible for compliance and that you comply with all applicable laws, rules and regulations. If you do not agree with any of our Terms, you are prohibited from using or accessing the Website or platform; your only way is to stop using the Website. Any use of the Website constitutes your acceptance of our Terms and Conditions as they may be changed and changed from time to time.</p>
                    <p>1.1. Modification {$settings.site_name} may revise our Terms at any time and without prior notice to you or third parties. By using the Website, you agree to be bound by the then current version of our Terms. Your continued use of the Website after the revision may affect transactions or other actions that you have already taken. We reserve the right to make any changes retroactively. You should call us frequently in case our Terms change.</p>
                    <p>2. Acceptability.</p>
                    <p>By using the site, you represent and warrant that:</p>
                    <p>1. at least 18 years of age and have full legal capacity in accordance with applicable law,</p>
                    <p>2. only transactions on {$settings.site_name} with the law - funds that belong to you have been received.</p>
                    <p>3. not achievements, fulfillment, conducts, engages in, abetting or abetting any illegal activity in connection with your relationship with us or through the use of {$settings.site_name},</p>
                    <p>4. compliance and compliance with laws, rules and regulations. We reserve the right to terminate your access to {$settings.site_name} for any reason and at our sole and absolute discretion. The use of {$settings.site_name} is void if prohibited by applicable law.</p>
                    <p>3. Restrictions on use</p>
                    <p>3.1. Prohibited Jurisdictions You are prohibited from using or accessing {$settings.site_name} from North Korea.User transactions in these jurisdictions are prohibited and {$settings.site_name} may withdraw any funds from users in these jurisdictions and donate them to charity at {$settings.site_name} 'sole discretion. By accessing this site or any of its services, you represent and warrant that you are not physically located in these prohibited jurisdictions.</p>
                    <p> 3.2. Funding Source You are prohibited from using or accessing {$settings.site_name} to transfer or exchange digital assets that are direct or indirect proceeds from any criminal or fraudulent activity, including terrorism or tax evasion. {$settings.site_name} reserves the right to refuse, delay or cancel a transaction that it perceives as a risk of criminal or fraudulent activity.</p>
                    <p>3.3. Abuse of the Platform You are prohibited from using or accessing {$settings.site_name} in an offensive manner. This may include, without limitation and at the sole discretion of {$settings.site_name}, the presentation of transactions or other data that impose an unreasonable or unmanageably large load on the {$settings.site_name} platform, whether it interferes with normal operation or not.</p>
                    <p>3.4. The counterparties of {$settings.site_name} and all of its services can only be used as a mechanism for translating software records between the user and {$settings.site_name}, i.e. all transactions processed by {$settings.site_name} are two-way transactions. You are prohibited from using {$settings.site_name} to translate accounting records with any other parties. For the avoidance of doubt, you must be the beneficial owner of both the shipping address of the incoming assets and the destination and return addresses for each transaction.</p>
                    <p>4. Prices, Exchange Rates and Confirmations Cryptocurrencies and digital assets are highly experimental and risky. {$settings.site_name} tries to provide accurate information on prices and exchange rates, but this information is highly volatile and can change rapidly without users necessarily being aware of these changes. For regular orders (that is, for all orders other than “Exact Amount” orders), the exchange rate you receive is calculated at the time the payment is accepted. Due to the different security between blockchains, your payment is usually considered “accepted” when one block is confirmed. {$settings.site_name} may sometimes accept payments with zero confirmations, although this is at the sole discretion of {$settings.site_name}.It is important to note that the payment broadcast to the blockchain network does not constitute {$settings.site_name} acceptance of this payment. User payment must be received and accepted by {$settings.site_name} within this period in order to receive the guaranteed exchange rate. You can contact customer service for more information on currency exchange rates. TNkejow8jvkVfxtmXxsAgL8SUBKJj7bSag only accepts one deposit per transaction ID (“TXID”). If your funds are credited to TXID with more than one deposit, you will need to contact support to receive a refund. The exchange rate will not be followed and your exchange will not be completed. User deposits in {$settings.site_name} that are not confirmed within 48 hours of discovery will be canceled. Refund requests will be granted once the deposit is confirmed on the blockchain.</p>
                    <p>5. Third Party Phishing Scams There are fake sites pretending to be {$settings.site_name}, known as “phishing scams.” They often use a misspelled URL that looks like “{$settings.site_name}.io” to trick users into sending them funds. WHICH IS NOT EXACTLY LOCATED IN THE “WWW.{$settings.site_name}.io” DOMAIN. {$settings.site_name} is not responsible for the funds that were sent to any phishing {$settings.site_name} scams. The user is responsible for verifying that he is visiting the correct domain and for looking for a security certificate in Your browser's URL string, which may look like this: Users should not trust private messages, requests or requests for funds from people claiming to represent {$settings.site_name} unless you have confirmed that it is an official request from a {$settings.site_name} employee. in doubt, contact us directly to check any messages. Report any phishing scams to our team through the help center,located here: {$settings.support_email}.</p>
                    <p>6. Costs From time to time, we may have to spend time solving problems that customers bring to us. If a customer's problem is not caused by our negligence or oversight, we reserve the right to reimburse reasonable administrative costs incurred to resolve the customer's problem.</p>
                    <p>7. {$settings.site_name} Investment Council does not endorse or recommend any specific digital assets, transactions or buying strategies. Any content on the {$settings.site_name} website or communication with company personnel does not constitute purchase or investment advice, and independent advice should be sought if necessary. You acknowledge and agree that all purchase decisions are made solely by you and {$settings.site_name} will not be held liable in any way for the results of your decisions. The digital assets available on the {$settings.site_name} platform are not securities and users should not expect to profit from the purchase of any digital asset. All purchases must be made with the intent to exploit the underlying utility of the digital asset.</p>
                    <p>8. Privacy and Transparency Statement {$settings.site_name} respects the privacy of its users by not asking for any information that is unnecessary to use the service or fulfill our obligations under applicable law. {$settings.site_name} also does not in any way hide the information that it requests or receives. Due to the inherent transparency of blockchains, transactions in and out of {$settings.site_name} are public and easily correlated. Using {$settings.site_name} to hide transactions or assets in any way is pointless, ineffective and reckless. Law enforcement agencies have full access to blockchain information that enters or exits the {$settings.site_name} system. You agree that {$settings.site_name} will willingly comply with all legal requests for information from her... We reserve the right to provide information to law enforcement officials and other third parties to respond to inquiries, participate in investigations, respond to legal proceedings, respond to orders of a court of competent jurisdiction and those exercising court powers, and to protect {$settings.site_name} and our users. By accepting our Terms, you expressly authorize us to export data outside of the jurisdiction in which you reside or are located when you access {$settings.site_name}.</p>
                    <p>9. Investigations You agree and accept that you will fully comply with any investigations initiated and conducted by {$settings.site_name} for any reason. This includes, but is not limited to, answering questions and providing {$settings.site_name} materials within the time frame we have set. You must not obstruct or delay any investigation by {$settings.site_name}.</p>
                    <p>10. Limitations The use of {$settings.site_name} may involve financial risk and should only be used as an experimental software utility. {$settings.site_name} is in no way liable for any loss, claim, statement, loss, injury, delay, accident, expense, business interruption or other expense (including but not limited to attorney's fees or costs of any claim or claim) , as well as for any incidental, direct, indirect, general, special, punitive, exemplary or consequential damages, loss of business reputation or business profit, loss of cryptocurrency or digital assets, business interruption, loss of data, computer failure or malfunction, or any other commercial or other losses directly or indirectly arising from or related to: our Terms; Confidentiality and Transparency Statement; any {$settings.site_name} services; using {$settings.site_name}; any use of your digital assets or cryptocurrencyby any other party not authorized by you (collectively, all of the above items are referred to herein as “Damages”). {$settings.site_name} is hereby released from your liability for any Damage. We disclaim any warranties or warranties, including any warranties of merchantability and warranties of fitness for a particular purpose. The foregoing limitations of liability apply regardless of whether the alleged liability or loss is based on contract, negligence, tort, strict liability or any other ground, even if {$settings.site_name} was warned or should have been aware of the possibility of such loss and damage, and regardless of success or effectiveness other remedies. Notwithstanding everything else in our Terms and Conditions, {$settings.site_name} 'aggregate aggregate liability for any Damages under this Agreement shall in no event exceed € 50.</p>
                    <p>11. Contact Us {$settings.site_name} has a reliable support staff ready to discuss with you any questions, complaints or concerns you may have with {$settings.site_name}. We cannot guarantee response time, but we endeavor to respond within 48 hours. The easiest way to contact us is through the {$settings.site_name} Help Center located here: {$settings.support_email}. For all correspondence, please include any required identification information such as your name, return email address or physical address, and any transaction IDs related to your request. Failure to do so may prevent us from providing an answer.</p>
                    <p>12. Copyright The materials contained on the Site are protected by applicable copyright and trademark laws and treaties.</p>
                    <p>13. Severability If any provision of these Terms is in any way illegal, otherwise invalid or unenforceable, such provision is excluded to the extent that it is invalid or unenforceable, and all other terms of this Agreement remain in full force and effect. To the extent permitted and possible, any invalid or unenforceable provision shall be deemed replaced by the term that is valid and enforceable and that comes closest to expressing the intent of such invalid or unenforceable provision.</p>
                    <p>14. Entire Agreement These Terms completely and exclusively set out the agreement between you and {$settings.site_name} regarding their subject matter. These Terms supersede and govern all prior or current understandings, statements, agreements or other communications between you and {$settings.site_name}, oral or written, regarding such subject matter.</p>
                </h2>
            </div>
        </section>
