...
<body data-new-gr-c-s-check-loaded="14.1052.0" data-gr-ext-installed="" style="position: relative; min-height: 100%; top: 0px;">
    ...
    <main class="d-flex flex-column">
                ...
                <div class="container__app container__app_px-15">
                    <div class="header__page d-flex justify-content-between align-items-center">
                        <div class="header__page-info d-flex flex-column">
                            <h1 class="header__home-slider1-item-title vis">Feedback of our clients</h1>
                        ...
                        <div class="header__page-pic d-none d-lg-flex align-items-center">
                            <img src="styles/assets/app/img/page__reviews.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="reviews ng-scope" ng-controller="ReviewsCtrl as vm">
            <div class="container__app container__app_px-15">
                <div class="row">
                    <div class="col-12 col-lg-7">
                        <h5 class="page__subtitle">Latest feedback:</h5>
                        <div class="card reviews__video-item mb-3 animated fadeIn ng-scope">
                            <div class="yt_preview ng-scope" ng-click="vm.showVideo(item)">
                                <img alt="" src="https://img.youtube.com/vi/Oz9zw7-_vhM/maxresdefault.jpg">
                                <button>
                    ...
                    <div class="col-12 col-lg-5">
                        <div id="video" class="d-flex flex-column">
                            <h5 class="page__subtitle">Video feedback:</h5>
                            <!-- ngIf: vm.ready -->
                            <div class="animated fadeIn ng-scope">
                                <div class="mb-2">
                                    <div class="reviews__video d-flex flex-column">
                                        <!-- ngRepeat: item in vm.reviews | limitTo:vm.limit:vm.offset -->
                                        <div class="card reviews__video-item mb-3 animated fadeIn ng-scope">
                                            <!-- ngSwitchWhen: true -->
                                            <div class="yt_preview ng-scope" ng-click="vm.showVideo(item)">
                                                <img alt="" src="https://img.youtube.com/vi/E6iLV4q58QU/maxresdefault.jpg">
                                                <button>
                                                    <svg width="68" height="48" viewBox="0 0 68 48">
                                                        <path d="M66.52,7.74c-0.78-2.93-2.49-5.41-5.42-6.19C55.79,.13,34,0,34,0S12.21,.13,6.9,1.55 C3.97,2.33,2.27,4.81,1.48,7.74C0.06,13.05,0,24,0,24s0.06,10.95,1.48,16.26c0.78,2.93,2.49,5.41,5.42,6.19 C12.21,47.87,34,48,34,48s21.79-0.13,27.1-1.55c2.93-0.78,4.64-3.26,5.42-6.19C67.94,34.95,68,24,68,24S67.94,13.05,66.52,7.74z"></path>
                                                        <path d="M 45,24 27,14 27,34"></path>
                                            ...
                                            <!-- ngSwitchWhen: false -->
                                        </div><!-- end ngRepeat: item in vm.reviews | limitTo:vm.limit:vm.offset -->
                                        <div class="card reviews__video-item mb-3 animated fadeIn ng-scope">
                                            <!-- ngSwitchWhen: true -->
                                            <div class="yt_preview ng-scope" ng-click="vm.showVideo(item)">
                                                <img alt="" src="https://img.youtube.com/vi/nTmF26NUZTA/maxresdefault.jpg">
                                                <button>
                                                    <svg width="68" height="48" viewBox="0 0 68 48">
                                                        <path d="M66.52,7.74c-0.78-2.93-2.49-5.41-5.42-6.19C55.79,.13,34,0,34,0S12.21,.13,6.9,1.55 C3.97,2.33,2.27,4.81,1.48,7.74C0.06,13.05,0,24,0,24s0.06,10.95,1.48,16.26c0.78,2.93,2.49,5.41,5.42,6.19 C12.21,47.87,34,48,34,48s21.79-0.13,27.1-1.55c2.93-0.78,4.64-3.26,5.42-6.19C67.94,34.95,68,24,68,24S67.94,13.05,66.52,7.74z"></path>
                                                        <path d="M 45,24 27,14 27,34"></path>
                                        ...
                                        <div class="card reviews__video-item mb-3 animated fadeIn ng-scope">
                                            <!-- ngSwitchWhen: true -->
                                            <div class="yt_preview ng-scope" ng-click="vm.showVideo(item)">
                                                <img alt="" src="https://img.youtube.com/vi/mMUnNsY2ztg/maxresdefault.jpg">
                                                <button>
                                                    <svg width="68" height="48" viewBox="0 0 68 48">
                                                        <path d="M66.52,7.74c-0.78-2.93-2.49-5.41-5.42-6.19C55.79,.13,34,0,34,0S12.21,.13,6.9,1.55 C3.97,2.33,2.27,4.81,1.48,7.74C0.06,13.05,0,24,0,24s0.06,10.95,1.48,16.26c0.78,2.93,2.49,5.41,5.42,6.19 C12.21,47.87,34,48,34,48s21.79-0.13,27.1-1.55c2.93-0.78,4.64-3.26,5.42-6.19C67.94,34.95,68,24,68,24S67.94,13.05,66.52,7.74z"></path>
                                                        <path d="M 45,24 27,14 27,34"></path>
