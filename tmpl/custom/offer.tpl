    ...
    <main class="d-flex flex-column">
                ...
                <div class="container__app container__app_px-15">
                    <div class="header__page d-flex justify-content-between align-items-center">
                        <div class="header__page-info d-flex flex-column">
                            <h1 class="header__page-info-title header__home-slider1-item-title vis">Investment program</h1>
                        ...
                        <div class="header__page-pic d-none d-lg-flex align-items-center">
                            <img src="styles/assets/app/img/page_invest.svg" alt>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class=" pb-0 pb-lg-5">
            <div class="container__app container__app_px-15">
                ...
                <h2 class="app__box-title">Relevant investment programs:</h2>
                <p class="app__box-text">To develop the project in future, support of young and promising NFT authors, help them with works creation and purchase advanced NFT, we introduced investment program that allows any person to make money from quickly developing and highly profitable NFT market, even if he/she does not have any experience of investments and does not know a lot about NFT.</p>
                <div class="darkSection__cards row mb-5 mt-4">
                    <div class="col-12 col-lg-6">
                        <div class="darkSection__cards-item darkSection__cards-item_white d-flex flex-column flex-sm-row align-items-center">
                            <div class="darkSection__cards-item-ico me-3 mb-3 mb-sm-0">
                                <svg width="76px" height="76px">
                                    <use xlink:href="#invest_ico_white"></use>
                                </svg>
                            </div>
                    ...
                    <div class="col-12 col-lg-6 ">
                        <div class="darkSection__cards-item darkSection__cards-item_white d-flex flex-column flex-sm-row align-items-center">
                            <div class="darkSection__cards-item-ico me-3 mb-3 mb-sm-0">
                                <svg width="76px" height="76px">
                                    <use xlink:href="#invest_ico_white2"></use>
                                </svg>
                            </div>
        ...
        <section class="darkSection darkSection_shadow-border mb-0" ng-controller="OfferCtrl as vm">
            ...
            <div class="container__app container__app_px-15 animated fadeIn">
                <div class="darkSection__box">
                    <!-- ngIf: vm.ready -->
                    <div class="investPage__list d-flex flex-row flex-nowrap flex-lg-column ng-scope">
                        <!-- ngRepeat: plan in ::vm.plans | limitTo:4:0 -->
                        <div class="investPage__list-item d-flex flex-column flex-lg-row ng-scope">
                            <picture class="investPage__list-item-picture" sx-video="">
                                <video playsinline="" autoplay="" loop="" muted="" disableremoteplayback="">
                                    <source type="video/mp4" src="styles/assets/app/video/plan_1.mp4">
                                </video>
                            </picture>
                            <div class="investPage__list-item-box">
                                <div class="row">
                                    <div class="col-12 col-lg-9">
                                        <div class="investPage__list-item-info d-flex flex-column">
                                            <div class="row">
                                                <div class="col-12 col-lg-6">
                                                    <div class="darkSection__elements-item-author investPage__list-item-boxing d-flex align-items-center m-0">
                                                        <picture class="darkSection__elements-item-author-pic me-2">
                                                            <source srcset="styles/assets/app/img/plan/a/1.jpeg 1x, styles/assets/app/img/plan/a/1@2x.jpeg 2x">
                                                            <img alt="" src="styles/assets/app/img/plan/a/1.jpeg">
                                                        </picture>
                                                        <div class="darkSection__elements-item-author-info d-flex flex-column justify-content-center">
                                                            <a class="darkSection__elements-item-author-info-title notranslate ng-binding">Rare</a>
                                                            <p class="darkSection__elements-item-author-info-category notranslate ng-binding">By pantlink</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-lg-6">
                                                    <div class="darkSection__elements-item-information d-flex flex-column investPage__list-item-boxing first_item" sx-tooltip="For next tariff you shall buy from <b>0 {include file="token.tpl"}</b> at stock exchange and top up your balance with them." title="Information" data-bs-offset="67,9" data-show="false">
                                                ...
                                                <div class="col-12 col-lg-4">
                                                    <div class="darkSection__elements-item-invest-row investPage__list-item-boxing d-flex flex-column justify-content-center align-items-start">
                                                        <p>
                                                ...
                                                <div class="col-12 col-lg-4">
                                                    <div class="darkSection__elements-item-invest-row investPage__list-item-boxing d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <div class="investPage__list-item-info d-flex flex-column">
                                            <div class="darkSection__elements-item-profit ">
                                            ...
                                            <!-- /account?act=deposit&plan_id=[[ ::plan.id ]]&curr=[[ plan.currency.code ]] -->
                                            <a class="darkSection__elements-item-btn btn btn-primary" href="?a=signup">
                                                <span>Register</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <p class="investPage__list-item-text" ng-switch="::plan.id">
                                            <span class="ng-scope">"RARE" tariff is available to you from the start, where base interest rate of 0.05% is charged for you hourly.</span>                                            
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="investPage__list-item d-flex flex-column flex-lg-row ng-scope">
                            <picture class="investPage__list-item-picture" sx-video="">
                                <video playsinline="" autoplay="" loop="" muted="" disableremoteplayback="">
                                    <source type="video/mp4" src="styles/assets/app/video/plan_2.mp4">
                                </video>
                            </picture>
                            <div class="investPage__list-item-box">
                                <div class="row">
                                        ...
                                        <div class="investPage__list-item-info d-flex flex-column">
                                            <div class="row">
                                                <div class="col-12 col-lg-6">
                                                    <div class="darkSection__elements-item-author investPage__list-item-boxing d-flex align-items-center m-0">
                                                        <picture class="darkSection__elements-item-author-pic me-2">
                                                            <source srcset="styles/assets/app/img/plan/a/2.jpeg 1x, styles/assets/app/img/plan/a/2@2x.jpeg 2x">
                                                            <img alt="" src="styles/assets/app/img/plan/a/2.jpeg">
                                                        </picture>
                                                        <div class="darkSection__elements-item-author-info d-flex flex-column justify-content-center">
                                                            <a class="darkSection__elements-item-author-info-title notranslate ng-binding">Epic</a>
                                    ...
                                    <div class="col-12">
                                        <p class="investPage__list-item-text" ng-switch="::plan.id">
                                            <span class="ng-scope">At "EPIC" tariff increased rate of 0.05% is charged for you hourly.</span>                                            
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="investPage__list-item d-flex flex-column flex-lg-row ng-scope">
                            <picture class="investPage__list-item-picture" sx-video="">
                                <video playsinline="" autoplay="" loop="" muted="" disableremoteplayback="">
                                    <source type="video/mp4" src="styles/assets/app/video/plan_3.mp4">
                                </video>
                            </picture>
                            <div class="investPage__list-item-box">
                                <div class="row">
                                        ...
                                        <div class="investPage__list-item-info d-flex flex-column">
                                            <div class="row">
                                                <div class="col-12 col-lg-6">
                                                    <div class="darkSection__elements-item-author investPage__list-item-boxing d-flex align-items-center m-0">
                                                        <picture class="darkSection__elements-item-author-pic me-2">
                                                            <source srcset="styles/assets/app/img/plan/a/3.jpeg 1x, styles/assets/app/img/plan/a/3@2x.jpeg 2x">
                                                            <img alt="" src="styles/assets/app/img/plan/a/3.jpeg">
                                                        </picture>
                                                        <div class="darkSection__elements-item-author-info d-flex flex-column justify-content-center">
                                                            <a class="darkSection__elements-item-author-info-title notranslate ng-binding">Legendary</a>
                                    ...
                                    <div class="col-12">
                                        <p class="investPage__list-item-text" ng-switch="::plan.id">
                                            <span class="ng-scope">At "LEGENDARY" tariff increased rate of 0.06% is charged for you hourly.</span>                                            
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="investPage__list-item d-flex flex-column flex-lg-row ng-scope">
                            <picture class="investPage__list-item-picture" sx-video="">
                                <video playsinline="" autoplay="" loop="" muted="" disableremoteplayback="">
                                    <source type="video/mp4" src="styles/assets/app/video/plan_4.mp4">
                                </video>
                            </picture>
                            <div class="investPage__list-item-box">
                                <div class="row">
                                        ...
                                        <div class="investPage__list-item-info d-flex flex-column">
                                            <div class="row">
                                                <div class="col-12 col-lg-6">
                                                    <div class="darkSection__elements-item-author investPage__list-item-boxing d-flex align-items-center m-0">
                                                        <picture class="darkSection__elements-item-author-pic me-2">
                                                            <source srcset="styles/assets/app/img/plan/a/4.jpeg 1x, styles/assets/app/img/plan/a/4@2x.jpeg 2x">
                                                            <img alt="" src="styles/assets/app/img/plan/a/4.jpeg">
                                                        </picture>
                                                        <div class="darkSection__elements-item-author-info d-flex flex-column justify-content-center">
                                                            <a class="darkSection__elements-item-author-info-title notranslate ng-binding">Genesis</a>
                                    ...
                                    <div class="col-12">
                                        <p class="investPage__list-item-text" ng-switch="::plan.id">
                                            <span class="ng-scope">At "GENESIS" tariff increased rate of 0.06% is charged for you hourly.</span>                                            
                                        </p>
                                    </div>
                                </div>
                            </div>
