...
<head>
    ...
    <link rel="shortcut icon" href="styles/img/Asset1@4x-8.png?v={$settings.site_name}" type="image/x-icon" />
            ...
            <div class="container ">
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-8 text-center d-flex flex-column pb-5 pt-5">
                        ...
                        <h1 class="omgd3">Unlock Your</h1>
                        <h1 class="omgd3" style="padding-top:0;"><b> Digital Asset Portfolio.</b></h1>
                        <p class="pb-4 pt-4">{$settings.site_name} is a digital asset investment platform. With proved expertise on fundamental and technical analysis, the platform offers high interest return and exclusive deals. Flexible yet strong, platform users are in control of their funds with simple and accessible interfaces. We aimed for a secure platform where everyone who believes in the technology and innovation can get the value they deserve - Thanks to you, we have succeeded.
                        <br><br>
                        We are experts in binary trades and playing one of the major parts in <a target="_blank" title="Open IQ option binary trade platform" href="https://iqoption.com/">IQ Option</a> and <a target="_blank" title="Open ExpertOption binary trade platform" href="https://expertoption.money/">Expert Option</a> trading platforms for many years.<br><br>
                                
                                <a target="_blank" title="Open IQ option binary trade platform" href="https://iqoption.com/"><img style="width:40%" src="/styles/img/iqlogo.png"/></a> &nbsp; and &nbsp; <a target="_blank" title="Open ExpertOption binary trade platform" href="https://expertoption.money/"><img style="width:40%" src="/styles/img/eologo.png"/></a>
                        </p>
                        <div class="pb-4">
                            <a class="btn" href="/login" role="button"><span>Get Started </span></a>
                            <a class="btn btn-outline" href="/aboutus" role="button"><span><i class="fas fa-file-alt"></i> Get to know us</span></a>
                        </div>
                    </div>

                    <div class="col-md-12 d-flex all-center pt-5">
                        <div class="site-plan d-flex flex-column">


                            <div class="row ">

                                <div class="col-lg-5 d-flex flex-column pb-4">
                                    <div class="bo-box all-center">
                                        <div class="row">

                                            <div class="col-5 d-flex flex-column all-center">
                                                <i class="icon icon-star3"></i>
                                                <h1><span id="hourlyint">0.010</span><small>%</small></h1>
                                                <p>Hourly Interest</p>
                                            </div>

                                            <div class="col-2 d-flex flex-column all-center">
                                                <small class="equip">Your Earning Equivalent</small>
                                            </div>

                                            <div class="col-5 d-flex flex-column all-center">
                                                <i class="icon icon-chart"></i>
                                                <h1><span id="dailyint">0.26</span><small>%</small></h1>
                                                <p>Daily Interest</p>
                                            </div>
                                    ...
                                    <div>
                                        <div class="row min-dep">

                                            <div class="col-12 pb-2">
                                                <p>Minimum Deposit Amounts</p>
                                            </div>
                                            {literal}
                                            ...
                                            <div class="col-6 col-xl-4 d-flex flex-column ">
                                                <p><i class="icon icon-arrow-right"></i>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0.847 0.876 329.254 329.256">
                                                        <path d="M330.102 165.503c0 90.922-73.705 164.629-164.626 164.629C74.554 330.132.848 256.425.848 165.503.848 74.582 74.554.876 165.476.876c90.92 0 164.626 73.706 164.626 164.627" fill="#FFC059"></path>
                                            ...
                                            <div class="col-6 col-xl-4 d-flex flex-column ">
												...
												C330.9,250.9,342.1,303.2,312.8,338.8z" fill="#FFC059"></path>
                                                    </svg>
                                                    <b>10</b> USD</p>
                                            </div>
                                            {/literal}
                                ...
                                <div class="col-lg-7 d-flex flex-column pt-4 pb-4 justify-content-center dsewq" style="">
                                    <div class="d-flex align-items-center mb-4"><i class="icon icon-organize color-yellow mr-2"></i>
                                        <h6 class="mb-0">Calculate your earnings</h6>
                                    </div>

                                    <div class="form-group">
                                        <i class="icon icon-ads float-ix"></i>
                                        <span class="usd float-ix">USD</span>
                                        <input type="text" value="40" class="form-control ng-pristine ng-valid ng-empty ng-touched" placeholder="Enter Amount (USD)" ng-model="user.company" id="inputsmoney" onfocus="calcthis();" oninput="calcthis();" onblur="calcthis();">
                                         <input type="hidden" id="txtDays" value="120">
										<label class="notice"><span style="color:#F89F35;">* </span> Calculator work on USD</label>
                                    </div>

                                    <div class="row resutl pt-1">

                                        <div class="col-6 col-md-3 d-flex flex-column ">
                                            <h4><span id="HourlyProfit">0.004</span><small> USD</small></h4>
                                            <p>Hourly Interest</p>
                                        </div>
                                        <div class="col-6 col-md-3 d-flex flex-column ">
                                            <h4><span id="DailyProfit">0.10</span><small> USD</small></h4>
                                            <p>Daily Interest</p>
                                        </div>
                                        <div class="col-6 col-md-3 mt-3 mt-md-0 d-flex flex-column ">
                                            <h4><span id="WeeklyProfit">0.73</span><small> USD</small></h4>
                                            <p>Weekly Interest</p>
                                        </div>
                                        <div class="col-6 col-md-3 mt-3 mt-md-0 d-flex flex-column " style="padding-right: 0px;">
                                            <h4><span id="MonthlyProfit">3.12</span><small> USD</small></h4>
                    ...
                    <div class="col-lg-9 pt-3 pb-3">
                        <div class="row">
                            <div class="col-lg-3 col-6">
                                <div class="d-flex dxx align-items-center justify-content-between">
                                    <i class="fas fa-circle"></i>
                                    <i class="fas fa-long-arrow-alt-right"></i>
                                </div>
                                <h6 class="title" style="margin-bottom:-12px; margin-top:15px">Register.</h6>
                                <p class="pb-4 pt-4">Only 1 minute and you're in. Enter the information you need to become a platform trader and start right away.</p>
                            </div>
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <h6 class="title" style="margin-bottom:-12px; margin-top:15px">Enter The Amount.</h6>

                                <p class="pb-4 pt-4"> You can invest as much as you want. Before giving your decision, you will be able to see your future earnings.</p>
                            </div>
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <h6 class="title" style="margin-bottom:-12px; margin-top:15px">Invest.</h6>

                                <p class="pb-4 pt-4">Invest and sit back. You can follow your investment status at any time and invest in limited time special offers.</p>
                            </div>
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <h6 class="title" style="margin-bottom:-12px; margin-top:15px">Withdraw Anytime.</h6>

                                <p class="pb-4 pt-4">Your profit is eligible to withdraw anytime after the first 24 hours for 2% fee.</p>
                            </div>
                        </div>
                    </div>
