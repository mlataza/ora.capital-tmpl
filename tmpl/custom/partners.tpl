                ...
                <div class="container__app container__app_px-15">
                    <div class="header__page d-flex justify-content-between align-items-center">
                        <div class="header__page-info d-flex flex-column">
                            <h1 class="header__page-info-title header__home-slider1-item-title vis">Partner offers</h1>
                        ...
                        <div class="header__page-pic d-none d-lg-flex align-items-center">
                            <img src="styles/assets/app/img/page__partner.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class=" pb-0 pb-lg-5">
            <div class="container__app container__app_px-15">
                <p class="app__box-subtitle">
                    ...
                    <span>Unique offers</span>
                </p>
                <h2 class="app__box-title">We offer 4 partner programs</h2>
                <p class="app__box-text mb-0">Partner program is an important component of any success. It is clear for us that development of any business requires advertisement and promotion.<br> For promotion we specially developed 4 partner programs where everyone can find the most convenient terms and participate in our marketing.</p>
            </div>
        </section>
        <div ng-controller="ForPartnersCtrl as vm" class="ng-scope">
            <section class="pantherPage">
                <div class="container__app container__app_px-15">
                    <div class="app__box pantherPage__box d-flex flex-column flex-xl-row">
                        <div class="app__box-info d-flex flex-column">
                            <h3 class="app__box-subtitle2 d-flex d-sm-block flex-column">
                                <span>Standard:</span> Standard program </h3>
                            <div class="app__box-steps wow animate__fadeInUp" data-wow-offset="80" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                                <div class="row">
                            ...
                            <p class="app__box-text-line wow animate__fadeInUp" data-wow-offset="80" data-wow-duration="1.7s" style="visibility: visible; animation-duration: 1.7s; animation-name: fadeInUp;">Publish your unique referral link at crypto currency forums, distribute it in social nets, at websites and in weblogs for maximum number of people could know about our project and its investment possibilities.</p>
                        </div>
                        <div class="app__box-pic app__box-pic_left pantherPage__pic">
                            <img src="styles/assets/app/img/panthers_pic_page.svg" alt="">
                        </div>
                    </div>
                </div>
            </section>
            <section class="darkSection no-border mb-0">
                ...
                <div class="container__app container__app_px-15">
                    <div class="darkSection__box d-flex flex-column">
                        <h2 class="darkSection__title">Special programs for {include file="token.tpl"} holders</h2>
                        <p class="darkSection__desc"></p>
                        <div class="pantherPage__list">
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="pantherPage__list-item">
                                        <h4 class="pantherPage__list-item-title">
                                            <span>Initial:</span> Initial program </h4>
                                        <p class="pantherPage__list-item-text">For the leaders who have the required {include file="token.tpl"} amount at balance. Partner program switches at 00:00 UTC daily.</p>
                                        <div class="pantherPage__list-item-cards">
                                            <div class="row">
                                                <div class="col-12 col-lg-6">
                                                    <div class="pantherPage__list-item-cards-item d-flex justify-content-between">
                                                        <div class="pantherPage__list-item-cards-item-left">To activate:</div>
                                                        <div class="pantherPage__list-item-cards-item-right d-flex flex-column">
                                                            <span>Hold</span>
                                                            <span class="ng-binding">50.01+ {include file="token.tpl"}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-lg-6">
                                                    <div class="pantherPage__list-item-cards-item pantherPage__list-item-cards-item_second d-flex justify-content-between">
                                                        <div class="pantherPage__list-item-cards-item-left">Unique<br>program bonus:</div>
                                                        <div class="pantherPage__list-item-cards-item-right d-flex flex-column">
                                                            <span>Level+:</span>
                                                            <span>5th</span>
                                                        </div>
                                        ...
                                        <div class="pantherPage__list-item-img mb-2">
                                            <img src="styles/assets/app/img/pantherPage_img1.svg" alt="">
                                        </div>
                                        <div class="mt-4 app__box-information app__box-information_black d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-between">
                                            <div class="app__box-information-text d-flex flex-column flex-sm-row align-items-center">
                                                <svg width="20px" height="20px">
                                                    <use xlink:href="#info2"></use>
                                                </svg>
                                                <p class="mb-0 mt-2 mt-sm-0 mx-auto ms-sm-2">If you have a special offer for us, please contact us.</p>
                                            </div>
                                            <div class="app__box-information-btn">
                                                <a class="btn btn-secondary btn_ico btn_ico_small" href="?a=support">
                                                    <svg>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="pantherPage__list-item">
                                        <h4 class="pantherPage__list-item-title">
                                            <span>Advanced:</span> Advanced program </h4>
                                        <p class="pantherPage__list-item-text">For the leaders who have the required {include file="token.tpl"} amount at balance. Partner program switches at 00:00 UTC daily.</p>
                                        <div class="pantherPage__list-item-cards">
                                            <div class="row">
                                                <div class="col-12 col-lg-6">
                                                    <div class="pantherPage__list-item-cards-item d-flex justify-content-between">
                                                        ...
                                                        <div class="pantherPage__list-item-cards-item-right d-flex flex-column">
                                                            <span>Hold</span>
                                                            <span class="ng-binding">150.03+ {include file="token.tpl"}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-lg-6">
                                        ...
                                        <div class="pantherPage__list-item-img mb-2">
                                            <img src="styles/assets/app/img/pantherPage_img2.svg" alt="">
                                        </div>
                                        <div class="mt-4 app__box-information app__box-information_black d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-between">
                                            <div class="app__box-information-text d-flex flex-column flex-sm-row align-items-center">
                                                <svg width="20px" height="20px">
            ...
            <section class="pantherPage__max">
                <div class="container__app container__app_px-15">
                    <div class="pantherPage__card">
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="pantherPage__list-item pantherPage__list-item_transparent">
                                    <h4 class="pantherPage__list-item-title d-flex d-sm-block flex-column">
                                        <span>Maximum:</span> Maximum program </h4>
                                    <p class="pantherPage__list-item-text mb-4">Unique offer for maximum income, for the leaders who have the required {include file="token.tpl"} amount at balance. Partner program switches at 00:00 UTC daily.</p>
                                    <div class="pantherPage__list-item-cards pantherPage__list-item-cards_max">
                                        <div class="row">
                                            <div class="col-12 col-lg-6">
                                                <div class="pantherPage__list-item-cards-item d-flex justify-content-between">
                                                    <div class="pantherPage__list-item-cards-item-left">To activate:</div>
                                                    <div class="pantherPage__list-item-cards-item-right d-flex flex-column">
                                                        <span>Hold</span>
                                                        <span style="color: #22293B;" class="ng-binding">250.04+ {include file="token.tpl"}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <div class="pantherPage__list-item-cards-item pantherPage__list-item-cards-item_second d-flex justify-content-between">
                                                    ...
                                                    <div class="pantherPage__list-item-cards-item-right d-flex flex-column">
                                                        <span>Level+</span>
                                                        <span>5th + 6th + 7th</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="app__box-information app__box-information_light d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-between">
                                        <div class="app__box-information-text d-flex flex-column flex-sm-row align-items-center">
                                            <svg width="20px" height="20px">
                                                <use xlink:href="#info2"></use>
                                            </svg>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="pantherPage__card-img d-flex">
                                    <img src="styles/assets/app/img/pantherPage_img3.svg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
