...
<head>
    ...
    <title>Recover access - {$settings.site_name}</title>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal__msg d-flex flex-column align-items-center">
                    ...
                    <div class="modal__msg-text">Your accound was found. Please check your e-mail address and follow confirm URL to reset your password.</div>
                    <button class="btn btn-primary mb-4 sx-close">Close</button>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal__msg d-flex flex-column align-items-center">
                    ...
                    <div class="modal__msg-title">Error</div>
                    <div class="modal__msg-text">No accounts found for provided info.</div>
                    <button class="btn btn-primary mb-4 sx-close">Close</button>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal__msg d-flex flex-column align-items-center">
                    ...
                    <div class="modal__msg-title">Success</div>
                    <div class="modal__msg-text">Request was confirmed. Login and password was sent to your email address.</div>
                    <button class="btn btn-primary mb-4 sx-close">Close</button>
                </div>
            </div>
        </div>
        ...
        <div class="login__help d-none d-xl-flex flex-column">
            <div class="login__help-item darkSection__stat-item d-flex align-items-center mb-3 ">
                ...
                <div class="darkSection__stat-item-info ms-1 d-flex flex-column-reverse">
                    <span>Enter e-mail address that you used for registration</span>
                    <span class="fw-normal">Enter e-mail address</span>
                </div>
            </div>
            <div class="login__help-item darkSection__stat-item d-flex align-items-center mt-4 mb-3">
                ...
                <div class="darkSection__stat-item-info ms-1 d-flex flex-column-reverse">
                    <span>We shall send you a link to email to confirm password reset</span>
                    <span class="fw-normal">Enter your email</span>
                </div>
            </div>
        </div>
        <div class="login__form auto_height">
            <div class="login__form-scroll">
                <form method=post name=forgotform onsubmit="return checkform();">
                    ...
                    <div class="login__form-title d-flex flex-column">
                        ...
                        <h2 class="app__box-title">Password reset</h2>
                    </div>
                    <div class="login-form__box d-flex flex-column">
                        <div class="login__form-input mb-3">
                            ...
                            <input type="email" id="email" class="form-control" name='email' value="{$frm.email|escape:htmlall}" ng-required="true" ng-minlength="2" maxlength="32" placeholder="username@domain.com" sx-autofocus>
                        </div>
                    </div>
                    ...
                    <div class="login__form-forgot d-flex mb-3">
                        ...
                        <a href="?a=login">Enter account</a>
                    </div>
                    <div class="module__captcha mb-3" ng-if="::global.captcha">
                        <sx-captcha ng-model="vm.data.captcha"></sx-captcha>
                    </div>
                    <button class="btn btn-primary mb-3" type="submit" ng-disabled="busy" sx-submit>Reset password</button>
