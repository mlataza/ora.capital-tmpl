...
<style>
.wait-pay-info > div:first-child {
display: none;
}

.sbmt.deposit-process, .sbmt.deposit-cancel {
    /* display: flex; */
...
.sbmt.deposit-process:hover, .sbmt.deposit-cancel {
    color: #1e2026;
    ...
    <section class="dashboard d-flex ng-scope" ng-controller="AccountLayoutCtrl as alc">
                ...
                <div class="menu__box d-flex flex-column">
                    ...
                    <a class="menu__box-el d-flex align-items-center" href="?a=add_funds">
                        <svg width="23px" height="23px">
                            <svg id="wallet2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.19 17.1"><path d="M4.48,16.25h2.7a2.6,2.6,0,0,0,.06-.56,2.91,2.91,0,0,0-2.91-2.91,3.73,3.73,0,0,0-.48,0v2.81A.63.63,0,0,0,4.48,16.25Z" transform="translate(-0.41 -2.5)" style="fill:none"/><path d="M2.6,15.63V13.35a2.9,2.9,0,1,0,4,4.15H4.48A1.88,1.88,0,0,1,2.6,15.63Z" transform="translate(-0.41 -2.5)" style="fill:none"/><path d="M8.24,15.69a3.55,3.55,0,0,1-.06.56H20.1v-2.5H17.6a2.5,2.5,0,0,1,0-5h2.5V6.25H4.48a1.9,1.9,0,0,1-.63-.11v5.68a3.73,3.73,0,0,1,.48,0A3.92,3.92,0,0,1,8.24,15.69Z" transform="translate(-0.41 -2.5)" style="fill:none"/><path d="M3.85,4.38A.63.63,0,0,0,4.48,5H17.6V3.75H4.48A.63.63,0,0,0,3.85,4.38Z" transform="translate(-0.41 -2.5)" style="fill:none"/><path d="M16.35,11.25A1.25,1.25,0,0,0,17.6,12.5h3.75V10H17.6A1.25,1.25,0,0,0,16.35,11.25Z" transform="translate(-0.41 -2.5)" style="fill:none"/><path d="M22,8.75h-.63V5.63A.63.63,0,0,0,20.73,5H18.85V3.13a.63.63,0,0,0-.62-.63H4.48A1.88,1.88,0,0,0,2.6,4.38v7.81a4.11,4.11,0,0,1,1.25-.37V6.14a1.9,1.9,0,0,0,.63.11H20.1v2.5H17.6a2.5,2.5,0,0,0,0,5h2.5v2.5H8.18a3.75,3.75,0,0,1-.41,1.25h13a.62.62,0,0,0,.62-.62V13.75H22a.62.62,0,0,0,.62-.62V9.38A.63.63,0,0,0,22,8.75ZM17.6,5H4.48a.63.63,0,1,1,0-1.25H17.6Zm3.75,7.5H17.6a1.25,1.25,0,0,1,0-2.5h3.75Z" transform="translate(-0.41 -2.5)" style="fill:#f8cc3d"/><polygon points="4.32 12.79 4.32 11.13 3.51 11.13 3.51 12.79 1.91 12.79 1.91 13.57 3.51 13.57 3.51 15.25 4.32 15.25 4.32 13.57 5.92 13.57 5.92 12.79 4.32 12.79" style="fill:#f8cc3d"/><path d="M8.24,15.69a3.92,3.92,0,0,0-3.91-3.91,3.73,3.73,0,0,0-.48,0,4.11,4.11,0,0,0-1.25.37A3.9,3.9,0,1,0,7.77,17.5a3.75,3.75,0,0,0,.41-1.25A3.55,3.55,0,0,0,8.24,15.69ZM4.33,18.6A2.91,2.91,0,0,1,2.6,13.35a3,3,0,0,1,1.25-.53,3.73,3.73,0,0,1,.48,0,2.91,2.91,0,0,1,2.91,2.91,2.6,2.6,0,0,1-.06.56,2.84,2.84,0,0,1-.59,1.25A2.93,2.93,0,0,1,4.33,18.6Z" transform="translate(-0.41 -2.5)" style="fill:#f8cc3d"/></svg>
        ...
        <div class="dashboard__box">
            <div class="row flex-nowrap">
                        ...
                        <div class="dashboard__main-head d-flex flex-column">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                ...
                                <div class="app__box-title-wrap">
                                    <h2 class="app__box-title vis mb-0">Confirm investment</h2>
                        ...
                        <div class="dashboard__wallet d-flex flex-column ng-scope">
                            <div class="dashboard__box">
                                <div class="row flex-nowrap flex-lg-wrap">
                                    <!-- ngRepeat: balance in vm.balances -->
                                    
									<div class="modal__msg d-flex flex-column align-items-center">            
               <div class="modal__msg-text">Check transfer details carefully</div>
               <div class="modal-table">
			      
				  {if $deposit.id > 0}
                  <div class="modal-table__item">
                     <p>Investment plan:</p>
                     <span class="notranslate ng-binding">{$deposit.name|escape:html} <!-- <small class="text-black-50 ml5 ng-binding">(pantlink)</small> --></span>
                  </div>
				   <div class="modal-table__item">
                     <p>Profit:</p>
                     <span class="notranslate ng-binding">{$deposit.percent}% {if $deposit.period == 'end' || $deposit.period == 'endh'}after {$deposit.periods} {$deposit.time_units}{if $deposit.periods != 1}s{/if}{else}{$deposit.period_name} for {if $deposit.periods == 0}lifelong{else}{$deposit.periods} {$deposit.time_units}{if $deposit.periods != 1}s{/if} {if $deposit.work_week}(mon-fri){/if}{/if}{/if}</span>
                  </div>
				  {/if}
				  {if isset($deposit.converted_fiat)}
				  <div class="modal-table__item">
                     <p>Payment system:</p>
                     <span class="notranslate css_fix003 ng-binding">
                        <svg width="25px" height="25px">
                           <img style="margin-right: 7px;" width="25px" height="25px" src="styles/assets/app/pay/{$deposit.converted_fiat|replace:"BTC":"48"|replace:"LTC":"68"|replace:"DOGE":"79"|replace:"ETH":"69"|replace:"DASH":"71"|replace:"XRP":"72"|replace:"BNB":"94"|replace:"TRX":"85"|replace:"BCH":"77"|replace:"USDT.ERC20":"82"|replace:"USDT.TRC20":"92"|replace:"USDT.BEP20":"102"|replace:"XLM":"86"}.svg"/>
                        </svg>
                        {$deposit.converted_fiat|replace:"BTC":"Bitcoin"|replace:"LTC":"Litecoin"|replace:"DOGE":"Dogecoin"|replace:"ETH":"Ethereum"|replace:"DASH":"Dash"|replace:"XRP":"Ripple"|replace:"TRX":"Tron"|replace:"BCH":"Bitcoin Cash"|replace:"USDT.ERC20":"Tether ERC20"|replace:"USDT.TRC20":"Tether TRC20"|replace:"USDT.BEP20":"Tether BEP20"|replace:"XLM":"Stellar"}
                     </span>
                  </div>
				  {/if}
				  {if isset($deposit.converted_amount)}
				  <div class="modal-table__item">
                     <p>Investment plan amount:</p>
                     <span class="upper notranslate ng-binding">{if $deposit.converted_amount > 0}{$deposit.converted_amount|number_format:2:".":","}{/if}</span>
                  </div>
                  <div class="modal-table__item mb-3">
                     <p>Deposit amount:</p>
                     <span class="upper notranslate ng-binding">{$deposit.amount|regex_replace:'/000000/':''} {$deposit.converted_fiat}</span>
                  </div>
				  {else}
				  <div class="modal-table__item">
                     <p>Investment plan amount:</p>
                     <span class="upper notranslate ng-binding">{$currency_sign}{$deposit.amount|number_format:2:".":","}</span>
                  </div>
				  <div class="modal-table__item mb-3">
                     <p>Deposit amount:</p>
                     <span class="upper notranslate ng-binding">{$currency_sign}{$deposit.amount}</span>
                  </div>
				  {/if}
				  {if isset($deposit.converted_amount)}
                  <div class="modal-table__item modal-table__item_address">
                     <p>Address:</p>
                     <span class="bold notranslate ng-binding">
                         {if isset($coin_payment_address)}{$coin_payment_address}{else}{$data.addr}{/if}
                        <button sx-clipboard="{if isset($coin_payment_address)}{$coin_payment_address}{else}{$data.addr}{/if}" title="Copy address">
                           <svg width="16px" height="16px">
                             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" id="copy2">
			                 <g opacity=".5" clip-path="url(#copy2_a)" fill="#5C677D">
				             <path d="M12.176 18H2.8a2.064 2.064 0 0 1-2.063-2.063V5.812c0-1.137.925-2.062 2.063-2.062h.375a.563.563 0 0 1 0 1.125H2.8a.939.939 0 0 0-.938.937v10.125c0 .517.421.938.938.938h9.375c.517 0 .937-.42.937-.938v-.374a.563.563 0 0 1 1.125 0v.374A2.064 2.064 0 0 1 12.176 18z"></path>
				             <path d="M15.176 13.5H7.3a2.064 2.064 0 0 1-2.063-2.063V2.063C5.238.925 6.163 0 7.301 0h7.875c1.138 0 2.062.925 2.062 2.063v9.374a2.064 2.064 0 0 1-2.062 2.063zM7.3 1.125a.939.939 0 0 0-.938.938v9.374c0 .517.421.938.938.938h7.875c.517 0 .937-.42.937-.938V2.063a.939.939 0 0 0-.937-.938H7.3z"></path>
			                 </g>
			                 <defs>
				             <clipPath id="copy2_a">
			   ...
			   {if isset($coin_payment_image)}
               <div class="modal__msg-text">Scan the code at withdrawal page in trade platform or wallet application.</div>
			   {/if}
               <div class="modal-img pointer" sx-clipboard="{$coin_payment_address}" title="Copy address">
                 {$coin_payment_image}
               </div>
			   
			   <div class="wait-pay-info" style="padding-bottom: 20px;">
			   {$payment_form}
			   </div>
			   
			   {if isset($deposit.converted_amount)}
               <div class="modal-info">
                  <div class="modal-info__item" style="width: 100%;">
                     <svg width="20px" height="20px">
                     ...
                     <p class="ng-binding">Send exactly <b>{$deposit.amount|regex_replace:'/000000/':''}</b> to <b>{if isset($coin_payment_address)}{$coin_payment_address}{else}{$data.addr}{/if}</b> this address only <b>{$deposit.converted_fiat}</b></p>
                  </div>
                  <!-- <div class="modal-info__item">
                     ...
                     <p>Make sure that net is correct</p>
                  </div> -->
               </div>
			   {/if}
