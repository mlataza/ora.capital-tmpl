        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal__msg d-flex flex-column align-items-center">
                    ...
                    <div class="modal__msg-title">Success</div>
                    <div class="modal__msg-text">The deposit has been saved. It will became active when the administrator checks statistics.</div>
                    <button class="btn btn-primary mb-4 sx-close">Close</button>
                </div>
            </div>
        </div>
...
<body style="position: relative; min-height: 100%; top: 0px;" data-new-gr-c-s-check-loaded="14.1052.0" data-gr-ext-installed="">
        ...
        <aside id="menuflexcolumnz" class="menu d-flex flex-column">
            ...
            <div sx-menu="active">
                ...
                <div class="menu__box d-flex flex-column">
                    ...
                    <a class="menu__box-el d-flex align-items-center active" href="?a=add_funds">
            ...
            <div class="row flex-nowrap">
                <div class="dashboard__col1">
                    <div class="dashboard__main flex-grow-1">
                        <div class="dashboard__main-head d-flex flex-column">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                ...
                                <div class="app__box-title-wrap">
                                    <h2 class="app__box-title vis mb-0">Top up Account</h2>
                        ...
                        <div class="dashboard__box ng-scope" ng-controller="TokenCtrl as vm">
                            <!-- ngIf: vm.ready -->
                            <div class="animated fadeIn ng-scope" ng-if="vm.ready">
                                <div class="row">
                                    <div id="refill" class="col-12 col-lg-6">
                                        <form method=post>
                                            <input type=hidden name=a value=deposit>
                                            <input type=hidden name=h_id value=-1>
                                            <input id="setprocessor" type=hidden name=type value="" data-fiat="{$p.fiat}">
                                            <h2 class="dashboard__box-subtitle">
                                                Balance top up:
                                            </h2>
                                            <div class="d-flex flex-column">
                                                <div class="card dashboard_card">
                                                    <div class="card__head d-flex justify-content-between align-items-center"> <span>Select net:</span>
                                                    ...
                                                    <div class="card__box">
                                                        <div class="dashboard__select ng-isolate-scope" sx-dropdown-event="vm.dd">
                                                            ...
                                                            <div id="loadprocess" class="dashboard__select-list">
                                                                ...
                                                                <div id="addprocess_{counter name=rex_1}" class="dashboard__select-list-option ng-scope" data-payment-id="process_{$p.id}" data-name="{$p.name|escape:html}">
                                                                    <img id="addprocessimg_{counter name=rex_6}" style="margin-right: 7px;border-radius: 8px;" width="40px" height="40px" src="styles/assets/app/pay/{$p.id}.svg" />
                                                                    <span class="dashboard__select-list-option-text notranslate ng-binding">{$p.name|escape:html}
                                            ...
                                            <div class="card dashboard_card">
                                                <div class="card__head d-flex justify-content-between align-items-center"> <span>Amount to Spend:</span>
                                                    <span class="card__head">2</span>
                                                </div>
                                                <div class="card__box">
                                                    <div class="row">
                                                        <div class="col-12 mb-3 mb-sm-0 position-relative">
                                                            <input type="text" class="form-control form-control_dashboard pe-100 ng-pristine ng-untouched ng-valid ng-isolate-scope ng-not-empty ng-valid-required ng-valid-maxlength" name=amount value='10.00' maxlength="12" required="required">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card dashboard_card mb-0">
                                                <div class="card__head d-flex justify-content-between align-items-center"> <span>Deposit to Account:</span>
                                                    <span class="card__head">3</span>
                                                </div>
                                                <div class="card__box">
                                                    <div class="row">
                                                        <div id="pending-default" class="col-12 col-sm-6 mb-3 mb-sm-0">

                                                        </div>
                                                        <div class="col-12 col-sm-6">
                                                            <button type="submit" class="btn btn-primary btn_ico btn_dashboard" ng-disabled="vm.data.amount <= 0 || vm.calc.rest < 0 || vm.formBusy || busy" sx-submit="">
                                                                <svg>
                                    ...
                                    <div class="col-12 col-lg-6 ng-pristine ng-invalid ng-invalid-required ng-valid-pattern ng-valid-minlength ng-valid-maxlength">
                                        <h2 class="dashboard__box-subtitle">
                                            Total withdrawal:
                                        </h2>
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                <div class="card dashboard_card ">
                                                    <div class="card__head d-flex justify-content-between align-items-center"> <span>Topped up in total:</span>
                                                        <span class="card__head_green">
                                                            <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <rect width="45" height="45" rx="8" fill="#1CBA6E"></rect>
                                                                ...
                                                                <path d="M34.5 28H29.5C27.57 28 26 26.43 26 24.5C26 22.57 27.57 21 29.5 21H34.5C34.776 21 35 21.224 35 21.5V27.5C35 27.776 34.776 28 34.5 28ZM29.5 22C28.121 22 27 23.122 27 24.5C27 25.878 28.121 27 29.5 27H34V22H29.5Z" fill="white"></path>
                                                                <path d="M29.5 26C28.673 26 28 25.327 28 24.5C28 23.673 28.673 23 29.5 23C30.327 23 31 23.673 31 24.5C31 25.327 30.327 26 29.5 26ZM29.5 24C29.225 24 29 24.224 29 24.5C29 24.776 29.225 25 29.5 25C29.775 25 30 24.776 30 24.5C30 24.224 29.775 24 29.5 24Z" fill="white"></path>
                                                            </svg>
                                                        </span>
                                                    </div>
                                                    <div class="card__box"> <b class="notranslate nowrap upper ng-binding">{$currency_sign}{$ab_formated.add_funds} USD</b>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="card dashboard_card ">
                                                    <div class="card__head d-flex justify-content-between align-items-center"> <span>Withdrawn in total:</span>
                                                        <span class="card__head_red">
                                                            <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <rect width="45" height="45" rx="8" fill="#F12F43"></rect>
                                                                <path d="M32 35H14C12.897 35 12 34.103 12 33V23C12 21.897 12.897 21 14 21H32C33.103 21 34 21.897 34 23V33C34 34.103 33.103 35 32 35ZM14 22C13.448 22 13 22.449 13 23V33C13 33.551 13.448 34 14 34H32C32.552 34 33 33.551 33 33V23C33 22.449 32.552 22 32 22H14Z" fill="white"></path>
                                                                <path d="M26.0002 15C25.8722 15 25.7442 14.951 25.6462 14.854L23.0002 12.207L20.3542 14.854C20.1592 15.049 19.8422 15.049 19.6472 14.854C19.4522 14.659 19.4522 14.342 19.6472 14.147L22.6472 11.147C22.8422 10.952 23.1592 10.952 23.3542 11.147L26.3542 14.147C26.5492 14.342 26.5492 14.659 26.3542 14.854C26.2562 14.951 26.1282 15 26.0002 15Z" fill="white"></path>
                                                                <path d="M23 20C22.724 20 22.5 19.776 22.5 19.5V11.5C22.5 11.224 22.724 11 23 11C23.276 11 23.5 11.224 23.5 11.5V19.5C23.5 19.776 23.276 20 23 20Z" fill="white"></path>
                                                                <path d="M23 32C20.794 32 19 30.206 19 28C19 25.794 20.794 24 23 24C25.206 24 27 25.794 27 28C27 30.206 25.206 32 23 32ZM23 25C21.346 25 20 26.346 20 28C20 29.654 21.346 31 23 31C24.654 31 26 29.654 26 28C26 26.346 24.654 25 23 25Z" fill="white"></path>
                                                                <path d="M16.5 28.5H15.5C15.224 28.5 15 28.276 15 28C15 27.724 15.224 27.5 15.5 27.5H16.5C16.776 27.5 17 27.724 17 28C17 28.276 16.776 28.5 16.5 28.5Z" fill="white"></path>
                                                                <path d="M30.5 28.5H29.5C29.224 28.5 29 28.276 29 28C29 27.724 29.224 27.5 29.5 27.5H30.5C30.776 27.5 31 27.724 31 28C31 28.276 30.776 28.5 30.5 28.5Z" fill="white"></path>
                                                            </svg>
                                                        </span>
                                                    </div>
                                                    <div class="card__box"> <b class="notranslate nowrap upper ng-binding">{$currency_sign}{$ab_formated.withdrawal} USD</b>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card dashboard_card">
                                            <div class="withdraw-banner">
                                                <img src="styles/assets/app/img/withdraw-bg.png" alt="">
                                                <h3>withdraw means</h3>
                                                <span>without fee</span>
                                                <p>with {include file="token.tpl"} token at balance</p> <a class="btn" href="?a=deposit">Investment program</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    {literal}
    <script>
        document.write("<script type='text/javascript' src='styles/assets/app/vendor-add.js?v=" + Date.now() + "'><\/script>");
