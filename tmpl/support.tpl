...
<body data-new-gr-c-s-check-loaded="14.1052.0" data-gr-ext-installed="" style="position: relative; min-height: 100%; top: 0px;">
    ...
    <main class="d-flex flex-column">
                ...
                <div class="container__app container__app_px-15">
                    <div class="header__page d-flex justify-content-between align-items-center">
                        <div class="header__page-info d-flex flex-column">
                            <h1 class="header__home-slider1-item-title vis">Our contacts</h1>
                        ...
                        <div class="header__page-pic d-none d-lg-flex align-items-center">
                            <img src="styles/assets/app/img/page_contacts.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="contacts ng-scope" ng-controller="ContactsCtrl as vm">
            <div class="container__app container__app_px-15">
                <div class="contacts__stat mt-0">
                    <div class="row">
                        <!-- ngIf: ::global.contacts.telegram[2] -->
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3 ng-scope">
                            <a class="contacts__stat-item contacts__stat-item_tg d-flex align-items-center" target="_blank" href="https://t.me">
                                <div class="contacts__stat-item-ico me-3">
                                    <svg width="50px" height="50px">
                                        <use xlink:href="#tgbig"></use>
                                    </svg>
                                </div>
                                <div class="contacts__stat-item-info ms-1 d-flex flex-column">
                                    <span>Telegram support:</span>
                                    <span class="ng-binding">@website_support</span>
                                </div>
                            </a>
                        </div><!-- end ngIf: ::global.contacts.telegram[2] -->
                        <!-- ngIf: ::global.contacts.email[0] -->
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3 ng-scope">
                            <a class="contacts__stat-item d-flex align-items-center" href="mailto::{$settings.support_email|default:'demo@goldcoders.com'}">
                                <div class="contacts__stat-item-ico me-3">
                                    <svg width="50px" height="50px">
                                        <use xlink:href="#contact2"></use>
                                    </svg>
                                </div>
                                <div class="contacts__stat-item-info ms-1 d-flex flex-column">
                                    <span>Clients support:</span>
                                    <span class="ng-binding">{$settings.support_email|default:'demo@goldcoders.com'}</span>
                                </div>
                            </a>
                        </div><!-- end ngIf: ::global.contacts.email[0] -->
                        <!-- ngIf: ::global.contacts.email[1] -->
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3 ng-scope">
                            <a class="contacts__stat-item d-flex align-items-center" href="mailto::tech@{$frm_env.SERVER_NAME}">
                                <div class="contacts__stat-item-ico me-3">
                                    <svg width="50px" height="50px">
                                        <use xlink:href="#contact3"></use>
                                    </svg>
                                </div>
                                <div class="contacts__stat-item-info ms-1 d-flex flex-column">
                                    <span>Financial questions:</span>
                                    <span class="ng-binding">tech@{$frm_env.SERVER_NAME}</span>
                                </div>
                            </a>
                        </div><!-- end ngIf: ::global.contacts.email[1] -->
                        <!-- ngIf: ::global.contacts.email[2] -->
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3 ng-scope">
                            <a class="contacts__stat-item d-flex align-items-center" href="mailto::partner@{$frm_env.SERVER_NAME}">
                                <div class="contacts__stat-item-ico me-3">
                                    <svg width="50px" height="50px">
                                        <use xlink:href="#contact4"></use>
                                    </svg>
                                </div>
                                <div class="contacts__stat-item-info ms-1 d-flex flex-column">
                                    <span>Partner offers:</span>
                                    <span class="ng-binding">partner@{$frm_env.SERVER_NAME}</span>
                                </div>
                            </a>
                        </div><!-- end ngIf: ::global.contacts.email[2] -->
                    </div>
                </div>
                <div class="contacts__box">
                    <h5 class="page__subtitle">Contact form</h5>
                    <div class="contacts__box-form d-flex flex-column">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="modal__msg d-flex flex-column align-items-center">
                                            ...
                                            <div class="modal__msg-text">Message has been successfully sent. We will back to you in next 48 hours. Thank you.</div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="modal__msg d-flex flex-column align-items-center">
                                            ...
                                            <div class="modal__msg-text">Invalid turing image.</div>
                                            <button class="btn btn-primary mb-4 sx-close">Close</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="modal__msg d-flex flex-column align-items-center">
                                            ...
                                            <div class="modal__msg-title">Error</div>
                                            <div class="modal__msg-text">Invalid email address.</div>
                                            <button class="btn btn-primary mb-4 sx-close">Close</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <form method=post name=mainform onsubmit="return checkform()" class="card ng-pristine ng-invalid ng-invalid-required ng-valid-pattern ng-valid-minlength ng-valid-maxlength ng-valid-email" autocomplete="off">
                            <input type=hidden name=a value=support>
                            <input type=hidden name=action value=send>
                            <div class="row">
                                <div class="col-12 col-lg-5">
                                    <div class="contacts__box-form-left d-flex flex-column">
                                        <div class="login__form-input mb-3">
                                            <svg width="25px" height="25px">
                                                <use xlink:href="#form_user"></use>
                                            </svg>
                                            <label for="username" class="form-label">Username:</label>
                                            <input type="text" id="username" name="name" value="{$frm.name|escape:htmlall}" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-pattern ng-valid-minlength ng-valid-maxlength" ng-model="vm.data.username" ng-required="true" ng-pattern="/^[a-z0-9-_]+$/i" ng-minlength="3" maxlength="32" placeholder="username" required="required">
                                        </div>
                                        <div class="login__form-input mb-3">
                                            <svg width="25px" height="25px">
                                            ...
                                            <input type="email" id="email" name="email" value="{$frm.email|escape:htmlall}" class="form-control ng-pristine ng-untouched ng-empty ng-valid-email ng-invalid ng-invalid-required ng-valid-maxlength" ng-model="vm.data.email" ng-required="true" maxlength="32" placeholder="username@domain.com" required="required">
                                        </div>
                                ...
                                <div class="col-12 col-lg-7">
                                    <div class="contacts__box-form-right d-flex flex-column">
                                        <div class="d-flex flex-column">
                                            <label for="message" class="form-label">Enter your message:</label>
                                            <textarea id="message" name=message class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-maxlength" rows="20" ng-model="vm.data.message" ng-required="true" maxlength="1000" placeholder="Enter your message, no more than 1000 characters ..." required="required">{$frm.message|escape:htmlall}</textarea>
                                        </div>
                                        <div class="contacts__box-form-right-bottom d-flex flex-column flex-sm-row justify-content-sm-between mt-auto align-items-center" style="padding-top: 50px;">
                                            <button class="btn btn-primary btn_ico contacts__box-form-right-bottom-btn" type="submit">
                                                <svg width="25px" height="25px">
                                                    <use xlink:href="#arr_right"></use>
                                                </svg>
                    ...
                    <div style="border-color:#EBEDEF" class="mt-5 mb-2 app__box-information app__box-information_light d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-between">
                        <div class="app__box-information-text d-flex flex-column flex-sm-row align-items-center">
                            <svg width="20px" height="20px">
                                <use xlink:href="#info2"></use>
                            </svg>
                            <p class="mb-0 mt-2 mt-sm-0 mx-auto ms-sm-2">Request response period - within 48 hours. If you do not receive answer for a long time, please, write to Telegram support</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="map">
            <div class="container__app">
                <div class="map-box wow animate__fadeInUp" data-wow-offset="80" data-wow-duration="1s" style="visibility: hidden; animation-duration: 1s; animation-name: none;">
                    <div class="map-list">
                        <div class="map-item">
