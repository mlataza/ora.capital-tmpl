    ...
    <main class="d-flex flex-column">
                ...
                <div class="container__app container__app_px-15">
                    <div class="header__page d-flex justify-content-between align-items-center">
                        <div class="header__page-info d-flex flex-column">
                            <h1 class="header__page-info-title header__home-slider1-item-title vis">Platform statistics</h1>
                        ...
                        <div class="header__page-pic d-none d-lg-flex align-items-center">
                            <img src="styles/assets/app/img/page_stat.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="ng-scope">
            ...
            <div class="animated fadeIn ng-scope">
                <section class="darkSection no-border mb-0">
                    ...
                    <div class="container__app container__app_px-15">
                        <div class="darkSection__box d-flex flex-column">
                            <div class="darkSection__stat mt-0 mb-5">
                                <div class="darkSection__stat-item d-flex align-items-center wow animate__fadeInUp" data-wow-offset="80" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                                    ...
                                    <div class="darkSection__stat-item-info ms-1 d-flex flex-column">
                                        <span>Invested:</span>
                                        <span class="notranslate ng-binding">{$currency_sign} {$settings.info_box_deposit_funds_generated} USD</span>
                                    </div>
                                </div>
                                <div class="darkSection__stat-item d-flex align-items-center wow animate__fadeInUp" data-wow-offset="80" data-wow-duration="1.1s" style="visibility: visible; animation-duration: 1.1s; animation-name: fadeInUp;">
                                    ...
                                    <div class="darkSection__stat-item-info ms-1 d-flex flex-column">
                                        <span>Paid:</span>
                                        <span class="notranslate ng-binding">{$currency_sign} {$settings.info_box_withdraw_funds_generated} USD</span>
                                    </div>
                                </div>
                                <div class="darkSection__stat-item d-flex align-items-center wow animate__fadeInUp" data-wow-offset="80" data-wow-duration="1.2s" style="visibility: visible; animation-duration: 1.2s; animation-name: fadeInUp;">
                                    ...
                                    <div class="darkSection__stat-item-info ms-1 d-flex flex-column">
                                        <span>Investors:</span>
                                        <span class="notranslate ng-binding">{$settings.info_box_total_accounts_generated}</span>
                                    </div>
                                </div>
                           ...
                           {loaddata name="top_investors" limit=$settings.index_top_investors var="top_investors" active=1}
                            ...
                            {if $top_investors[0]['username'] != ''}
							{if $top_investors[2]['username'] != ''}
                            <h2 class="darkSection__title">Top 3 investors</h2>
							{else}
							<h2 class="darkSection__title">Top investors</h2>
							{/if} 
                            <p class="darkSection__desc">shall gey per cent from sale of our NFT</p>
                            <div class="statPage__top" style="margin: 70px auto 30px;">
                                <!-- ngIf: ::vm.topDeposits.length -->
                                <div class="row ng-scope">
                                    <!-- ngIf: ::vm.topDeposits[1] -->
									{if $top_investors[1]['username'] != ''}
                                    <div class="col-12 col-lg-4 order-2 order-lg-1 ng-scope">
                                        <div class="statPage__top-item">
                                            <div class="statPage__top-item-img d-flex flex-column">
                                                <img src="styles/assets/app/img/statPage_pic1.svg" height="140px" alt="">
                                                <img src="styles/assets/app/img/statPage_pic1_fig.svg" width="100px" alt="">
                                            </div>
                                            <div class="statPage__top-item-title d-flex flex-column flex-sm-row justify-content-sm-between align-items-center notranslate">
                                                <span class="ng-binding">{$top_investors[1]['username']}</span>
                                                <span class="upper ng-binding">
                                                    <sum class="ng-binding">{$top_investors[1]['amount']}</sum> usd
                                                </span>
                                            </div>
                                        </div>
                                    </div>
									...
									{/if}                                    
                                    <div class="col-12 col-lg-4 order-1 order-lg-2 ng-scope">
                                        <div class="statPage__top-item statPage__top-item_first">
                                            <div class="statPage__top-item-img d-flex flex-column">
                                                <img src="styles/assets/app/img/statPage_pic2.svg" height="140px" alt="">
                                                <img src="styles/assets/app/img/statPage_pic2_fig.svg" width="100px" alt="">
                                            </div>
                                            <div class="statPage__top-item-title d-flex flex-column flex-sm-row justify-content-sm-between align-items-center notranslate">
                                                <span class="ng-binding">{$top_investors[0]['username']}</span>
                                                <span class="upper ng-binding">
                                                    <sum>{$top_investors[0]['amount']}</sum> usd
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    {if $top_investors[2]['username'] != ''}
                                    <div class="col-12 col-lg-4 order-3 order-lg-3 ng-scope">
                                        <div class="statPage__top-item">
                                            <div class="statPage__top-item-img d-flex flex-column">
                                                <img src="styles/assets/app/img/statPage_pic3.svg" height="140px" alt="">
                                                <img src="styles/assets/app/img/statPage_pic3_fig.svg" width="100px" alt="">
                                            </div>
                                            <div class="statPage__top-item-title d-flex flex-column flex-sm-row justify-content-sm-between align-items-center notranslate">
                                                <span class="ng-binding">{$top_investors[2]['username']}</span>
                                                <span class="upper ng-binding">
                                                    <sum class="ng-binding">{$top_investors[2]['amount']}</sum> usd
                                                </span>
                                            </div>
                                        </div>
                                    </div>
									...
									{/if}
                                </div><!-- end ngIf: ::vm.topDeposits.length -->
                            </div>
							{/if}
                ...
                <!-- ngIf: ::vm.latest.length -->
                <div class="container__app container__app_px-15 ng-scope">
                    <div class="statPage__online">
                        <div class="statPage__online-head d-flex align-items-center" style="padding-top: 50px;">
                        ...
                        <div class="statPage__online-table">
                            <table class="table table-striped table_long">
                                ...
                                <tbody>    
                                    ...
                                    <tr class="ng-scope">
                                        <td data-title="ID">
                                            <a class="pointer ng-binding" title="Batch operations">{$s.batch|truncate:8:"":true}</a>
                                        </td>
                                        <td class="nowrap" data-title="Operation type">
										    {if $s.type == "withdrawal"}
                                            <svg width="18px" height="18px">
                                                <use xlink:href="#withdraw" class="ng-scope"></use>
                                            </svg>
											{/if}
											{if $s.type == "deposit"}
											<svg width="18px" height="18px">
                                                <use xlink:href="#deposit" class="ng-scope"></use>
                                            </svg>
											{/if}
                                            <span class="ng-binding">{$s.type|replace:"withdrawal":"Withdraw means"}</span>
                                        </td>
                                        <td data-title="Investor">
                                            <span class="hidd notranslate ng-binding" >{$s.username|escape:html}</span>
                                        </td>
                                        <td data-title="Date"  class="ng-binding">{$s.dd}</td>
                                        <td class="upper nowrap notranslate ng-binding" data-title="Amount">
                                           {$s.actual_amount|fiat:$s.ec} USD
                                        </td>
                                        <td class="nowrap notranslate css_fix003" data-title="P/S" >                                            
                                            <div class="ng-scope">
												<img width="24px" height="24px" src="styles/assets/app/pay/{$s.ec}.svg" />
                                                <span class="ng-binding">{$s.ec|replace:"48":"Bitcoin"|replace:"69":"Ethereum"|replace:"68":"Litecoin"|replace:"71":"Dash"|replace:"79":"Dogecoin"|replace:"43":"Payeer"|replace:"18":"PerfectMoney"|replace:"82":"Tether ERC20"|replace:"92":"Tether TRC20"|replace:"102":"Tether BEP20"|replace:"51":"ePayCore"|replace:"94":"BNB"}</span>
                                            </div>                                            
                                        </td>
									...
									<tr class="ng-scope">
                                        <td colspan=7 align=center>
                                            <a class="pointer ng-binding" title="No transactions found">No transactions found</a>
                                        </td>
                                    </tr>
									{/foreach}
                                </tbody>
                        ...
                        <!-- ngIf: vm.latestLimit < vm.latest.length -->
                    </div>
                </div><!-- end ngIf: ::vm.latest.length -->
