...
<style>
    ...
    .sbmt.deposit-process:hover,
    .sbmt.deposit-cancel {
        color: #1e2026;
        background-position: right;
    }

    .card__box-input-form:after {
        background: initial;
    }
                    ...
                    <div class="dashboard__main flex-grow-1">
                                    ...
                                    <div class="modal-body">
                                        <div class="modal__msg d-flex flex-column align-items-center">
                                            ...
                                            <div class="modal__msg-text">
                                                ...
                                                {if $errors.amount_too_big}Sorry, the maximal deposit is {$errors.amount_too_big}.<br>{/if}
                                    ...
                                    <div class="modal__msg d-flex flex-column align-items-center">
                                        ...
                                        <div class="modal-table">
                                            ...
                                            <div class="modal-table__item">
                                                <p>Investment plan:</p>
                                                <span class="notranslate ng-binding">{$deposit.name|escape:html}
                                                    <!-- <small class="text-black-50 ml5 ng-binding">(pantlink)</small> --></span>
                                            </div>
                                            <div class="modal-table__item">
                                                <p>Profit:</p>
                                            ...
                                            <div class="modal-table__item">
                                                <p>Compound:</p>
                                                <span class="upper notranslate ng-binding">{$deposit.compound|number_format}%</span>
                                            </div>
                                            {/if}
                                            {if $deposit.fees.fee}
                                            <div class="modal-table__item">
                                                <p>Deposit Fee:</p>
                                                <span class="upper notranslate ng-binding">{$deposit.fees.fee|fiat} ({$deposit.fees.percent}%)</span>
                                            </div>
                                            <div class="modal-table__item">
                                                <p>Investment plan amount:</p>
                                                <span class="upper notranslate ng-binding">{$deposit.to_deposit|number_format:2:".":","}</span>
                                            </div>
                                            {else}
                                            <div class="modal-table__item">
                                                <p>Investment plan amount:</p>
                        ...
                        <div class="row animated fadeIn ng-scope">
                            <div class="col-12">
                                ...
                                <form name=spend method=post class="card dashboard__search dashboard_card ng-pristine ng-valid ng-valid-required ng-valid-pattern ng-valid-minlength ng-valid-maxlength">
                                    ...
                                    <div class="d-flex flex-column align-items-center" style="padding-top: 30px;">
                                        <div class="wait-pay-info justify-content-between align-items-center">
