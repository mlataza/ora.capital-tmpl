                    ...
                    <div id="dashboardwallet-boxz" class="dashboard__wallet-box">
                        <div class="row flex-nowrap flex-lg-wrap">
                            ...
                            <div>
                                ...
                                {if $say eq 'processed'}
                                    {if $batch eq ''}Withdrawal request has been successfully saved.
                                    {else} Withdrawal has
                                    been processed. Batch id: {$batch}{/if}
                                    <br><br>
                                {/if}
                                ...
                                {if $fatals}
                                    ...
                                    {if $fatal == 'times_limit' || $fatals.times_limit}
                                        <div class="msg">You can withdraw {$settings.limit_withdraw_period_times} per
                                ...
                                You have not done any deposits yet. Withdrawal function will be available after a
                                deposit.
                                <br><br>
                                {/if}
                                    ...
                                    <form method=post>
                                        ...
                                        <table cellspacing=0 cellpadding=2 border=0 class="form deposit_confirm">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="password" name="transaction_code" class=inpts size=15>
                                                </td>
                                            </tr>
                                            {/if}
                                            ...
                                            <tr>
                                                <th>2FA Code:</th>
                                                <td><input type="text" name="tfa_code" class=inpts size=15> <input
                                                        type="hidden" name="tfa_time" id="tfa_time"></td>
                                            </tr>
                                            {literal}
                                            ...
                                            {/if}
                                            <tr>
                                                <td colspan=2><input id="hyipconfirm" name="hyipconfirm" type=submit
                                                        value="Confirm" class=sbmt></td>
                                            </tr>
                                        </table>
                                    </form>
                                </div>
                                ...
                                <div style="display: none;" id="customPaymentModule" class="customPaymentModule">
                                    <input type="button" id="json_buttonWithdraw" class="json_buttonWithdraw sbmt"
                                        value="Confirm"
                                ...
                                <script src="mixpanel/app-assets/js/scripts/loader.js?v=7.2" type="text/javascript">
                                </script>
                                <script>
                                        ...
                                        <div class="dashboard__dynamic">
                                            ...
                                            <table cellspacing=0 cellpadding=2 border=0>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{$currency_sign}<b>{if $ab_formated.withdraw_pending != 0}{$ab_formated.withdraw_pending|amount_format}{/if}</b>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table cellspacing=0 cellpadding=2 border=0>
                                                ...
                                                {foreach from=$ps item=p}
                                                    <tr>
                                                        <td>{if $p.available > 0}<input type="radio" name="ec"
                                                                    value="{$p.id}"
                                                                    {if $frm.ec == $p.id || $wfch}{assign var="wfch" value=0}checked{/if}>{/if}
                                                            </td>
                                                            <td><img src="images/{$p.id}.gif" width=44 height=17
                                                                    align=absmiddle> {$p.name|escape:html}</td>
                                                            ...
                                                            <td>{if $p.account != ''}{$p.account|escape:html}
                                                                {else}<a href="{"?a=edit_account"|encurl}"><i>not
                                                                        set</i></a>{/if}
                                                            </td>
                                                        </tr>
                                                    {/foreach}
