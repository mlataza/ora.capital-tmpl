        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal__msg d-flex flex-column align-items-center">
                    ...
                    <div class="modal__msg-title">Confirm your registration.</div>
                    <div class="modal__msg-text">Thank you for your registration.<br>Please check your e-mail account and confirm the registration.</div>
        ...
        <div class="login__help d-none d-xl-flex flex-column">
            ...
            <div class="login__help-item darkSection__stat-item d-flex align-items-center mt-4 mb-3">
                ...
                <div class="darkSection__stat-item-info ms-1 d-flex flex-column-reverse">
                    ...
                    <span class="fw-normal">We generate reliable password and PIN code for you</span>
                </div>
            </div>
            <div class="login__help-item darkSection__stat-item d-flex align-items-center mt-4">
                ...
                <div class="darkSection__stat-item-info ms-1 d-flex flex-column-reverse">
                    <span>You can indicate your Telegram or Inviter login</span>
                        ...
                        <form class="d-flex flex-column">
                            ...
                            <div class="login-form__box d-flex flex-column">
                                ...
                                <div class="login__form-input mb-3">
                                    ...
                                    <input type="text" id="passField" class="form-control" ng-model="vm.data.password" ng-required="true" ng-minlength="6" maxlength="32" placeholder="**********" ng-readonly="true">
                                    <button type="button" class="d-flex btn login__form-input-copy" name=password value="{$frm.password|escape:html}" title="Copy to clipboard">
                            ...
                            <button class="btn btn-primary mb-3" type="submit" disabled>Create account</button>
