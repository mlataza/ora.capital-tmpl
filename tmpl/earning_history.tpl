...
<body data-new-gr-c-s-check-loaded="14.1049.0" data-gr-ext-installed="" style="position: relative; min-height: 100%; top: 0px;">
        ...
        <aside id="menuflexcolumnz" class="menu d-flex flex-column">
            ...
            <div sx-menu="active">
                ...
                <div class="menu__box d-flex flex-column">
                    ...
                    {/if}
                    <a class="menu__box-el d-flex align-items-center active" href="?a=deposit_history">
                        <svg width="20px" height="20px">
                        ...
                        <div class="dashboard__box ng-scope" ng-controller="HistoryCtrl as vm">
                            ...
                            <div class="row animated fadeIn ng-scope" ng-if="vm.ready">
                                <div class="col-12">
                                    ...
                                    <!-- list -->
                                    <!-- ngIf: ::vm.history.length -->
                                    <div ng-if="::vm.history.length" class="ng-scope">
                                        <!-- filters -->
                                        <!-- ngIf: ::vm.history.length > 2 -->
                                        <form method=post name=opts>
                                            <input type=hidden name=a value=history>
                                            <input type=hidden name=page value={$current_page}>

                                            <div class="card dashboard__search dashboard_card ng-scope">
                                                <div class="d-flex flex-column flex-lg-row justify-content-lg-between align-items-center align-items-lg-end">
                                                    <div class="row flex-grow-1">
                                                        ...
                                                        <div class="col-12 col-lg-6"> <span class="dashboard__search-label">Operation type:</span>
                                                            <div class="dashboard__select ng-isolate-scope" sx-dropdown-event="vm.dd.type">
                                                                <div id="select-operations" class="dashboard__select-check" ng-click="vm.dd.type =! vm.dd.type">
                                                                    <div class="dashboard__select-check-ico">
                                                                        <svg width="40px" height="40px">
                                                                            <use ng-href="#transfer" xlink:href="#transfer"></use>
                                                                        </svg>
                                                                    </div> <span id="set-operations" class="ng-binding">All operations</span>
                                                                </div>
                                                                <div id="load-operations" class="dashboard__select-list">
                                                                    <div class="dashboard__select-list-option ng-scope" data-operations="All operations" data-value="">
                                                                        <svg class="dashboard__select-list-option-ico" width="24px" height="24px">
                                                                            <use ng-href="#transfer" xlink:href="#transfer"></use>
                                                                        </svg> <span class="dashboard__select-list-option-text ng-binding">All operations</span>
                                                                    </div>
                                                                    {section name=opt loop=$options}
                                                                    <div class="dashboard__select-list-option ng-scope" data-operations="{$options[opt].type_name}" data-value="{$options[opt].type}">
                                                                        <svg class="dashboard__select-list-option-ico" width="24px" height="24px">
                                                                            <use ng-href="#transfer" xlink:href="#transfer"></use>
                                                                        </svg> <span class="dashboard__select-list-option-text ng-binding">{$options[opt].type_name|replace:"Transfer from external processings":"Transfer from external"|replace:"Deposit returned to user account":"Deposit returned"}</span>
                                                                    </div>
                                                                    {/section}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-lg-6"> <span class="dashboard__search-label">Operation currency:</span>
                                                            <div class="dashboard__select ng-isolate-scope" sx-dropdown-event="vm.dd.status">
                                                                <div id="select-currencies" class="dashboard__select-check" ng-click="vm.dd.status =! vm.dd.status">
                                                                    <div class="dashboard__select-check-ico">
                                                                        <svg width="40px" height="40px">
                                                                            <use ng-href="#list" xlink:href="#list"></use>
                                                                        </svg>
                                                                    </div> <span id="set-currencies" class="ng-binding">All currencies</span>
                                                                </div>
                                                                <div id="load-currencies" class="dashboard__select-list">
                                                                    <div class="dashboard__select-list-option ng-scope" data-currencies="All currencies" data-value="">
                                                                        <svg class="dashboard__select-list-option-ico" width="24px" height="24px">
                                                                            <use ng-href="#list" xlink:href="#list"></use>
                                                                        </svg> <span class="dashboard__select-list-option-text ng-binding">All currencies</span>
                                                                    </div>
                                                                    {section name=ec loop=$ecs}
                                                                    <div class="dashboard__select-list-option ng-scope" data-currencies="{$ecs[ec].name}" data-value="{$ecs[ec].id}">
                                                                        <svg class="dashboard__select-list-option-ico" width="24px" height="24px">
                                                                            <use ng-href="#list" xlink:href="#list"></use>
                                                                        </svg> <span class="dashboard__select-list-option-text ng-binding">{$ecs[ec].name}</span>
                                                                    </div>
                                                                    {/section}
                                                                </div>
                                                            </div>
                                        ...
                                        <!-- end ngIf: ::vm.history.length > 2 -->
                                        <!-- //filters -->
                                        <!-- no_result -->
                                        <div class="dashboard__table-text dashboard__table-text_small ng-hide">
                                            <p>Nothing was found for your request
                                                <br>Try to change settings or reset filters</p>
                                            <a class="btn btn-primary pointer"> <span>Reset filters</span>
                                            </a>
                                        </div>
                                        <!-- //no_result -->
                                        <!-- table -->
                                        <div class="card dashboard__table">
                                            <table class="table table-striped table_long">
                                                ...
                                                <tbody>
                                                    ...
                                                    <!-- ngRepeat: history in vm.filtered = (vm.history | filter:vm.filter) | limitTo:vm.limit -->
                                                    <tr class="animated-fast fadeIn ng-scope">
                                                        <td data-title="Operation type">
                                                            {if $t.transtype == "Withdrawal request" || $t.transtype == "Withdrawal" || $t.transtype == "Internal Transaction"}
                                                            <svg width="18px" height="18px">
                                                                <!-- ngSwitchWhen: true -->
                                                                <!-- ngSwitchWhen: false -->
                                                                <use ng-switch-when="false" ng-href="#withdraw" xlink:href="#withdraw" class="ng-scope"></use>
                                                                <!-- end ngSwitchWhen: -->
                                                            </svg>
                                                            {else}
                                                            <svg width="18px" height="18px">
                                                                <!-- ngSwitchWhen: true -->
                                                                <use ng-switch-when="true" ng-href="#deposit" xlink:href="#deposit" class="ng-scope"></use>
                                                                <!-- end ngSwitchWhen: -->
                                                                <!-- ngSwitchWhen: false -->
                                                            </svg>
                                                            {/if}
                                                            <span ng-bind-html="::history.descr" class="ng-binding">{$t.transtype}</span>
                                                        </td>
                                                        <td class="fw-normal nowrap ng-binding" data-title="Date">{$t.d}</td>
                                                        <td class="fw-bold nowrap notranslate upper" data-title="Amount">
                                                            <!-- ngSwitchWhen: true -->
                                                            <!-- ngSwitchWhen: false -->
                                                            <div ng-switch-when="false" class="ng-binding ng-scope">{$t.amount|number_format:2:".":","}</div>
                                                            <!-- end ngSwitchWhen: -->
                                                        </td>
                                                        <td class="css_fix003" data-title="System/Balance">
                                                            <!-- ngSwitchWhen: true -->
                                                            <!-- ngSwitchWhen: false -->
                                                            <div class="notranslate nowrap ng-scope" ng-switch-when="false">
                                                                <img style="border-radius: 3px;" width="24px" height="24px" src="styles/assets/app/pay/{$t.ec}.svg" />
                                                                <span ng-bind="::history.currency.name" class="ng-binding">{$t.ec_name}</span>
                                                            </div>
                                                            <!-- end ngSwitchWhen: -->
                                                        </td>
                                                        <td ng-switch="::history.status" data-title="Status">
                                                            {if $t.transtype != "Withdrawal request"}
                                                            <span class="success ng-scope" ng-switch-when="3">Completed</span>
                                                            {else}
                                                            <span class="wait ng-scope" ng-switch-when="1">Progress</span>
                                                            {/if}
                                                        </td>
                                                    </tr>
                                                    <!-- end ngRepeat: history in vm.filtered = (vm.history | filter:vm.filter) | limitTo:vm.limit -->
                                                    {/foreach}
                                                </tbody>
                                            </table>
                                        </div>
                                        <!-- //table -->
                                        <!-- load_more -->
                                        <!-- ngIf: vm.limit < vm.filtered.length -->
                                        <!-- <div class="load-box pointer ng-scope" ng-if="vm.limit < vm.filtered.length" ng-click="vm.loadMore(10)">
                                            <p>Download more</p>
                                        </div> -->
                                        {literal}
                                        ...
                                        <div class="row" style="margin-left: -7px;">
                                            <div onclick="javascript:go('{$prev_page}')" class="load-box pointer ng-scope" style="width: 5%;margin-right: 10px;margin-left: 10px;">
                                                <p>&lt;&lt;</p>
                                            </div>
                                            {section name=p loop=$pages}
                                            {if $pages[p].current == 1}
                                            <div class="load-box ng-scope" style="width: 5%;margin-right: 10px;margin-left: 10px;background-color: #f8cc3d;">
                                                <p>{$pages[p].page}</p>
                                            </div>
                                            {else}
                                            <div onclick="javascript:go('{$pages[p].page}')" class="load-box pointer ng-scope" style="width: 5%;margin-right: 10px;margin-left: 10px;">
                                                <p>{$pages[p].page}</p>
                                            </div>
                                            {/if}
                                            {/section}
                                            <div onclick="javascript:go('{$next_page}')" class="load-box pointer ng-scope" style="width: 5%;margin-right: 10px;margin-left: 10px;">
                                                <p>&gt;&gt;</p>
                                            </div>
                                        </div>
                                        {/if}
                                        ...
                                        <!-- end ngIf: vm.limit < vm.filtered.length -->
                                        <!-- //load_more -->
                                    </div>
                                    <!-- end ngIf: ::vm.history.length -->
                                    <!-- //list -->
                                </div>
                            </div>
                            <!-- end ngIf: vm.ready -->
	...
	<script>
    document.write("<script type='text/javascript' src='styles/assets/app/vendor-history.js?v=" + Date.now() + "'><\/script>");
    </script>
