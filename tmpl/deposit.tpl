        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal__msg d-flex flex-column align-items-center">
                    ...
                    <div class="modal__msg-text">You can deposit once a month only.</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal__msg d-flex flex-column align-items-center">
                    ...
                    <div class="modal__msg-text">The deposit has been successfully saved.</div>
                    <button class="btn btn-primary mb-4 sx-close">Close</button>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal__msg d-flex flex-column align-items-center">
                    ...
                    <div class="modal__msg-title">Success</div>
                    <div class="modal__msg-text">The deposit has been saved. It will become active when the administrator checks statistics.</div>
                    <button class="btn btn-primary mb-4 sx-close">Close</button>
                </div>
            </div>
        </div>
...
<body data-new-gr-c-s-check-loaded="14.1029.0" data-gr-ext-installed="" style="position: relative; min-height: 100%; top: 0px;">
            ...
            <div sx-menu="active">
                ...
                <div class="menu__box d-flex flex-column">
                    ...
                    <a class="menu__box-el d-flex align-items-center" href="?a=deposit_list">
                        ...
                        </svg> <span>Shares Equity</span>
                    </a>
                </div>
                <h2 class="menu__title">Finances</h2>
                <div class="menu__box d-flex flex-column">
                    <a class="menu__box-el d-flex align-items-center pointer active" href="?a=deposit">
                        <svg width="20px" height="20px">
                ...
                <div class="menu__box d-flex flex-column">
					...
					<a class="menu__box-el d-flex align-items-center" href="?a=security">
                        <svg width="20px" height="20px" id="2fa" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.4 19.83"><path d="M6.59,9.14a.64.64,0,0,0-.92,0,.65.65,0,0,0,0,.93l3.25,3.25a.64.64,0,0,0,.46.19.63.63,0,0,0,.46-.2l5.68-5.68a.65.65,0,0,0,0-.93.68.68,0,0,0-.92,0L9.38,11.92Z" transform="translate(-1.49 -0.09)" style="fill:#f8cc3d"/><path d="M18.48,2.55,10.36.12a.5.5,0,0,0-.34,0L1.91,2.55a.58.58,0,0,0-.42.56V12C1.49,15.72,7,19,10,19.9a.5.5,0,0,0,.17,0,.47.47,0,0,0,.17,0c3-.93,8.53-4.18,8.53-7.86V3.11A.59.59,0,0,0,18.48,2.55Zm-.75,1V12c0,2.73-4.44,5.67-7.54,6.7-3.1-1-7.54-4-7.54-6.7V3.54l7.54-2.26Z" transform="translate(-1.49 -0.09)" style="fill:#f8cc3d"/></svg> 
                ...
                <div class="dashboard__col1">
                    <div class="dashboard__main flex-grow-1">
                        <div class="dashboard__main-head d-flex flex-column">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                ...
                                <div class="app__box-title-wrap">
                                    <h2 class="app__box-title vis mb-0">Open deposit</h2>
                        ...
                        <form method=post name="spendform">
                            ...
                            <input id="setprocessor" type=hidden name=type value="">
                            <input id="setpplan" type=hidden name=h_id value=''>
                            <div class="dashboard__box ng-scope" ng-controller="DepositCtrl as vm">
                                ...
                                <div class="row animated fadeIn ng-scope" ng-if="vm.ready">
                                    <div class="col-12 col-xl-6">
                                        <h2 class="dashboard__box-subtitle">Investment stages:</h2>
                                        <form id="form" class="d-flex flex-column ng-pristine ng-valid ng-valid-required ng-valid-maxlength" name="vm.form" autocomplete="off" novalidate="" ng-submit="vm.submit()">
                                            <div class="card dashboard_card">
                                                ...
                                                <div class="card__box">
                                                    <div class="dashboard__select ng-isolate-scope" sx-dropdown-event="vm.dd">
                                                        <div id="dashselectcheckz" class="dashboard__select-check">
                                                            <div class="dashboard__select-check-ico">
                                                                <img id="defaultimgpay" style="border-radius: 8px;" width="40px" height="40px" src="" />
                                                            </div>
                                                            <span class="notranslate ng-binding"><span id="name-paymentz"> </span><!-- <i class="upper ng-binding">(usdt)</i> --></span>
                                                        </div>
                                                        <div id="loadprocess" class="dashboard__select-list">

                                                            {* counter name=rex_1 start=0 *}
                                                            {* counter name=rex_6 start=0 *}
                                                            {section name=p loop=$ps}

                                                            <div id="directpay_{counter name=rex_1}" class="dashboard__select-list-option ng-scope" data-payment-id="process_{$ps[p].id}" data-name="{$ps[p].name}" {if $ps[p].status}spend-funds-proccesor="process_{$ps[p].id}"{/if} {if $ps[p].balance > 0 and $ps[p].status == 1}spend-funds-account-balance="account_{$ps[p].id}"{else}spend-funds-account-balance="none"{/if} >
                                                                <img id="directimg_{counter name=rex_6}" style="margin-right: 7px;border-radius: 8px;" width="40px" height="40px" src="styles/assets/app/pay/{$ps[p].id}.svg" />
                                                                <span class="dashboard__select-list-option-text notranslate ng-binding">{$ps[p].name}
                                                                    <!-- <i class="upper ng-binding">(usdt)</i> --></span>
                                                            </div>
                                                            {/section}
                                                ...
                                                <!-- ngIf: !(vm.curr | inArray:['usd', 'rub']) -->
                                                <div class="app__box-information border-0 p-0 mt-3 d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-between animated fadeIn ng-scope">
                                                    <div class="app__box-information-text d-flex flex-column flex-sm-row align-items-center">
                                                        <svg width="20px" height="20px">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" id="info2">
                                                                <path d="M10.833 5a.833.833 0 1 1-1.667 0 .833.833 0 0 1 1.667 0zM10 15.833a.625.625 0 0 1-.626-.625V8.75h-.833a.625.625 0 0 1 0-1.25h1.458c.345 0 .625.28.625.625v7.083c0 .345-.28.625-.625.625z" fill="#1CBA6E"></path>
                                                                <path d="M10 20C4.486 20 0 15.514 0 10S4.486 0 10 0s10 4.486 10 10-4.486 10-10 10zm0-18.75c-4.825 0-8.75 3.925-8.75 8.75s3.925 8.75 8.75 8.75 8.75-3.925 8.75-8.75S14.825 1.25 10 1.25z" fill="#1CBA6E"></path>
                                                                <path d="M11.875 15.833h-3.75a.625.625 0 0 1 0-1.25h3.75a.625.625 0 0 1 0 1.25z" fill="#1CBA6E"></path>
                                                            </svg>
                                                        </svg>
                                                        <p class="mb-0 mt-2 mt-sm-0 mx-auto ms-sm-2 fw-normal">Coins shall be charged after 10 confirmations of net.</p>
                                                    </div>
                                                </div><!-- end ngIf: !(vm.curr | inArray:['usd', 'rub']) -->
                                            </div>
                                            <div class="card">
                                                <div class="card__head d-flex justify-content-between align-items-center">
                                                    <span>Select spend funds:</span>
                                                    <span class="card__head_success">2</span>
                                                </div>
                                            </div>
                                            <div class="change-nft">
                                                <label>
                                                    <input id="spend_funds" type="radio" name="type" value="" ng-model="vm.group" ng-value="1" class="ng-pristine ng-untouched ng-valid ng-not-empty" checked>
                                                    <div id="change_funds" class="change-nft__item">From</div>
                                                </label>
                                                <label>
                                                    ...
                                                    <div id="change_account" class="change-nft__item">From Wallet Balance<span>new</span>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="dashboard__box-checked" style="min-height:117px">
                                                <div id="loadplans" class="row">

                                                    {* counter name=rex_2 start=0 *}
                                                    {* counter name=rex_3 start=0 *}
                                                    {* counter name=rex_4 start=0 *}
                                                    {foreach from=$plans item=plan name=fplans}
                                                    <div style="margin-bottom: 20px;" class="col-6 col-sm-3 animated-fast fadeIn ng-scope" id="planselect_{counter name=rex_2}" data-plan-id="{$plan.id}" data-package-name="{$plan.name|escape:html}" {foreach from=$plan.plans item=o} data-plan-name="{$o.name|escape:html}" data-plan-min="{$o.min_deposit}" data-plan-max="{if $o.max_deposit == 0}&infin;{else}{$o.max_deposit}{/if}" data-percent="{$o.percent}" {/foreach} data-days="{$plan.q_days}" data-period="{if $plan.period == ""}After{$plan.period} {$plan.q_days}{if $plan.period == ""} Hour{/if}{if $plan.period != 1}s{/if}{else}{$plan.period} for {if $plan.q_days == 0}lifelong{else}{$plan.q_days} {if $plan.period === Hourly}Hour{/if}{if $plan.period === Daily || $plan.period === Weekly || $plan.period === BiWeekly || $plan.period === Monthly || $plan.period|replace:' ':'' === 2Monthly || $plan.period|replace:' ':'' === 3Monthly || $plan.period|replace:' ':'' === 6Monthly || $plan.period === Yearly}Day{/if}{if $plan.q_days != 1}s{/if}{if $plan.work_week}(mon-fri){/if}{/if}{/if}">
                                                        <label id="planlabel_{counter name=rex_3}" class="dashboard__box-checked-item " title="Select plan">
                                                            <span class="dashboard__box-checked-item-check"></span>
                                                            <picture class="dashboard__box-checked-item-picture" style="box-shadow: 0 15px 20px rgba(114, 66, 214, 0.25)" sx-video="">
                                                                <video width="100%" playsinline="" autoplay="" loop="" muted="" disableremoteplayback="">
                                                                    <source type="video/mp4" src="styles/assets/app/video/{if $plan.name == "Rare" || $plan.name=="RARE" || $plan.name=="rare" }plan_1{elseif $plan.name=="Epic" || $plan.name=="EPIC" || $plan.name=="epic" }plan_2{elseif $plan.name=="Legendary" || $plan.name=="LEGENDARY" || $plan.name=="legendary" }plan_3{elseif $plan.name=="Genesis" || $plan.name=="GENESIS" || $plan.name=="genesis" }plan_4{else}plan_{counter name=rex_4}{/if}.mp4">
                                                                </video>
                                                            </picture>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="card dashboard__data dashboard_card">
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="dashboard__data-item dashboard__data-item_dark d-flex flex-column justify-content-center">
                                                            <h2 class="dashboard__data-item-head d-flex align-items-center">
                                                                ...
                                                                <span id="package-name" class="notranslate ng-binding"></span>
                                                            </h2>
                                                            <span id="plan-name" class="dashboard__data-item-name notranslate ng-binding"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="dashboard__data-item dashboard__data-item_green d-flex justify-content-between align-items-center">
                                                            <span class="dashboard__data-item-name">Profit per hour:</span>
                                                            <span id="plan-profit" class="dashboard__data-item-percent notranslate ng-binding"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-xl-6 col-xxl-4">
                                                        <div class="dashboard__data-item dashboard__data-item_light d-flex flex-column justify-content-center">
                                                            <span class="dashboard__data-item-label">Min deposit:</span>
                                                            <span id="plan-min-depo" class="dashboard__data-item-money upper notranslate ng-binding"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-xl-6 col-xxl-4">
                                                        <div class="dashboard__data-item dashboard__data-item_light d-flex flex-column justify-content-center">
                                                            <span class="dashboard__data-item-label">Max deposit:</span>
                                                            <span id="plan-max-depo" class="dashboard__data-item-money upper notranslate ng-binding"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-xl-12 col-xxl-4">
                                                        <div class="dashboard__data-item dashboard__data-item_light d-flex flex-column justify-content-center">
                                                            <span class="dashboard__data-item-label">Duration:</span>
                                                            <span id="plan-period" class="dashboard__data-item-money ng-binding"></span>
                                                        </div>
                                                    </div>                                                    
                                                </div>
                                            </div>
                                                ...
                                                <div class="card__box">
                                                    <div class="row">
                                                        <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                                            <input id="plan-amount" name=amount value='' type="text" class="form-control form-control_dashboard ng-pristine ng-untouched ng-valid ng-isolate-scope ng-not-empty ng-valid-required ng-valid-maxlength" ng-model="vm.data.amount" ng-required="true" sx-amount="vm.sxAmount" maxlength="12" placeholder="" required="required">
                                                        </div>
                                                        <div class="col-12 col-sm-6">
                                                            <button class="btn btn-primary btn_ico btn_dashboard" type="submit" sx-submit="">
                                                                <svg>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 25 25" id="arr_right">
                                                                        ...
                                                                        <g opacity=".8" clip-path="url(#arr_right_a)" fill="#1E2026">
                                                                            <path d="M15.272 13.054H4.554a.555.555 0 0 1 0-1.108h10.718a.554.554 0 0 1 0 1.108z"></path>
                                                                            <path d="M12.315 16.01a.555.555 0 0 1-.392-.947l2.565-2.564-2.565-2.565a.555.555 0 0 1 .784-.784l2.957 2.957a.555.555 0 0 1 0 .784l-2.957 2.957a.55.55 0 0 1-.392.163z"></path>
                                                                            <path d="M12.87 20.63a8.088 8.088 0 0 1-7.568-5.156.554.554 0 1 1 1.032-.405 6.986 6.986 0 0 0 6.536 4.453A7.03 7.03 0 0 0 19.89 12.5a7.03 7.03 0 0 0-7.021-7.022 6.986 6.986 0 0 0-6.536 4.453.554.554 0 1 1-1.032-.405A8.088 8.088 0 0 1 12.87 4.37c4.482 0 8.13 3.647 8.13 8.13 0 4.483-3.648 8.13-8.13 8.13z"></path>
                                                                        </g>
                                                                        <defs>
                                                                            <clipPath id="arr_right_a">
                                                                                <path fill="#fff" transform="translate(4 4)" d="M0 0h17v17H0z"></path>
                                                                            </clipPath>
                                                                        </defs>
                                                                    </svg>
                                                                </svg>
                                    ...
                                    <div class="col-12 col-xl-6">
                                        ...
                                        <div class="card dashboard_card ">
                                            <div class="card__head d-flex justify-content-between align-items-center">
                                                <span>Deposit growth dynamics</span>
                                                    ...
                                                    <div class="col-12 col-sm-6 col-xl-6 col-lg-12">
                                                        <div class="dashboard__dynamic-item d-flex align-items-center">
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 50 50" id="invest">
                                                                        ...
                                                                        <defs>
                                                                            <clipPath id="invest_a">
                                                                                <path fill="#fff" transform="translate(10 10)" d="M0 0h30v30H0z"></path>
                                                                            </clipPath>
                                                                        </defs>
                                                                    </svg>
                                                                </svg>
                                                            ...
                                                            <div class="dashboard__dynamic-item-info d-flex flex-column">
                                                                <span>Deposit:</span>
                                                                <span id="profitdeposit" class="upper notranslate ng-binding"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6 col-xl-6 col-lg-12">
                                                        <div class="dashboard__dynamic-item d-flex align-items-center">
                                                            ...
                                                            <div class="dashboard__dynamic-item-info dashboard__dynamic-item-info_green d-flex flex-column">
                                                                <span>Total profit:</span>
                                                                <span id="totalprofit" class="upper notranslate ng-binding"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="dashboard__dynamic-graph d-flex justify-content-between">
                                                            <div class="dashboard__dynamic-graph-col d-flex flex-column-reverse" data-title="1 day">
                                                                <div id="bar_1day" class="dashboard__dynamic-graph-col-first" style="height: 60px;"></div>
                                                                <div class="dashboard__dynamic-graph-col-second on1">
                                                                    <span id="percent_1day" ng-bind="vm.calc.percent.day1 | number | suffix:'%'" class="ng-binding"></span>
                                                                </div>
                                                            </div>
                                                            <div class="dashboard__dynamic-graph-col d-flex flex-column-reverse" data-title="10 day">
                                                                <div id="bar_10days" class="dashboard__dynamic-graph-col-first" style="height: 60px;"></div>
                                                                <div class="dashboard__dynamic-graph-col-second on2 notranslate">
                                                                    <span id="percent_10days" ng-bind="vm.calc.percent.day10 | number | suffix:'%'" class="ng-binding"></span>
                                                                </div>
                                                            </div>
                                                            <div class="dashboard__dynamic-graph-col d-flex flex-column-reverse" data-title="30 days">
                                                                <div id="bar_30days" class="dashboard__dynamic-graph-col-first" style="height: 60px;"></div>
                                                                <div class="dashboard__dynamic-graph-col-second on3 notranslate">
                                                                    <span id="percent_30days" ng-bind="vm.calc.percent.day30 | number | suffix:'%'" class="ng-binding"></span>
                                                                </div>
                                                            </div>
                                                            <div class="dashboard__dynamic-graph-col d-flex flex-column-reverse" data-title="60 days">
                                                                <div id="bar_60days" class="dashboard__dynamic-graph-col-first" style="height: 60px;"></div>
                                                                <div class="dashboard__dynamic-graph-col-second on4 notranslate">
                                                                    <span id="percent_60days" ng-bind="vm.calc.percent.day60 | number | suffix:'%'" class="ng-binding"></span>
                                                                </div>
                                                            </div>
                                                            <div class="dashboard__dynamic-graph-col d-flex flex-column-reverse" data-title="240 days">
                                                                <div id="bar_100days" class="dashboard__dynamic-graph-col-first" style="height: 60px;"></div>
                                                                <div class="dashboard__dynamic-graph-col-second on5 notranslate">
                                                                    <span id="percent_100days" ng-bind="vm.calc.percent.total | number | suffix:'%'" class="ng-binding"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                <div class="dashboard__dynamic-profit card dashboard_card">
                                                    <div class="dashboard__dynamic-profit-graph dashboard__dynamic-profit-graph_orange d-flex justify-content-between">
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                            <span style="height: 38px;opacity: 0.15"></span>
                                                        </div>
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                            <span style="height: 25px;opacity: 0.2"></span>
                                                        </div>
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                            <span style="height: 84px;opacity: 0.35"></span>
                                                        </div>
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                            <span style="height: 67px; opacity: 1"></span>
                                                        </div>
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                            <span style="height: 67px;opacity: 0.35"></span>
                                                        </div>
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                    ...
                                                    <p class="dashboard__dynamic-profit-text">Profit per 1 day:</p>
                                                    <p id="profit1day" class="dashboard__dynamic-profit-count upper notranslate ng-binding"></p>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="dashboard__dynamic-profit card dashboard_card">
                                                    <div class="dashboard__dynamic-profit-graph dashboard__dynamic-profit-graph_pupr d-flex justify-content-between">
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                            <span style="height: 38px;opacity: 0.15"></span>
                                                        </div>
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                    ...
                                                    <p class="dashboard__dynamic-profit-text">Profit per 7 days:</p>
                                                    <p id="profit7days" class="dashboard__dynamic-profit-count upper notranslate ng-binding"></p>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="dashboard__dynamic-profit dashboard__dynamic-profit_mob card">
                                                    <div class="dashboard__dynamic-profit-graph dashboard__dynamic-profit-graph_blue d-flex justify-content-between">
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                            <span style="height: 38px;opacity: 0.15"></span>
                                                        </div>
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                    ...
                                                    <p class="dashboard__dynamic-profit-text">Profit per 30 days:</p>
                                                    <p id="profit30days" class="dashboard__dynamic-profit-count upper notranslate ng-binding"></p>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="dashboard__dynamic-profit card">
                                                    <div class="dashboard__dynamic-profit-graph dashboard__dynamic-profit-graph_yellow d-flex justify-content-between">
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                            <span style="height: 38px;opacity: 0.15"></span>
                                                        </div>
                                                        <div class="dashboard__dynamic-profit-graph-col">
                                                    ...
                                                    <p class="dashboard__dynamic-profit-text">Profit per 240 days:</p>
                                                    <p id="profit60days" class="dashboard__dynamic-profit-count upper notranslate ng-binding"></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="dashboard__footer d-flex flex-column flex-lg-row align-items-center justify-content-lg-between">
                        ...
                        <p class="m-0 d-flex align-items-center">
                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M10.0625 10.7917C9.95045 10.7917 9.83852 10.7491 9.75328 10.6633L6.69078 7.60083C6.60854 7.51859 6.5625 7.40718 6.5625 7.29172V3.20831C6.5625 2.96681 6.7585 2.77081 7 2.77081C7.2415 2.77081f 7.4375 2.96681 7.4375 3.20831V7.11024L10.3717 10.0445C10.5426 10.2154 10.5426 10.4924 10.3717 10.6633C10.2865 10.7491 10.1745 10.7917 10.0625 10.7917Z" fill="#5C677D"></path>
    ...
    {literal}
    <script>
        document.write("<script type='text/javascript' src='styles/assets/app/vendor-deposit.js?v=" + Date.now() + "'><\/script>");
    </script>
    {/literal}
