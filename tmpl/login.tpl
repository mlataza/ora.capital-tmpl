    ...
    <section class="login d-grid">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="modal__msg d-flex flex-column align-items-center">
                            ...
                            <div class="modal__msg-text">Your login or password or turing image code is wrong. Please check this information.</div>
        ...
        <div class="login__form ">
            <div class="login__form-scroll">
                ...
                <form method=post name=mainform onsubmit="return checkform()" autocomplete="off">
                    ...
                    <div class="login__form-scroll">
                        ...
                        <div class="login-form__box d-flex flex-column">
                            ...
                            <div class="login__form-input mb-3">
                                ...
                                <input type="text" class="form-control" id="username" name=username value='{$frm.username|escape:"html"}' placeholder="{$frm.username|default:" username"}">
                            </div>
                            <div class="login__form-input mb-3">
                                <svg width="25px" height="25px">
